...
public class AppZosCore {
	...
	public static void initEnv(Environment environment) {
		...
		initWithSpringEnv(environment);

	}

//	static boolean inited = false;

	private static void initWithSpringEnv(Environment environment) {

//		IT.state(!inited, "check call's");
//		inited = true;

		AutoInitClassProperty.ENV_PROP_LOADER = environment == null ? null : (key) -> environment.getProperty(key);
