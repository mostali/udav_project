...
public class AFCC {
	...
	public static final String DIR_COMS = NodeID.COMS_DIR;
	public static final String DIR_FORMS = NodeID.FORMS_DIR;
	public static final String DIR_PLANES = NodeID.PLANES_DIR;
	public static final String DIR_PAGES = NodeID.PAGES_DIR;
	...
	public static String relativizeAppFile(Path path, String... defRq) {
		try {
			...
			return ARG.throwMsg(() -> X.f("RelativizeAppFile from .planes : %s", path), defRq);
		}
	}
...
//		}
	...
	public enum FileType {
		...
		public static FileType of(String filename, FileType... defRq) {
			...
			return ARG.throwErr(() -> new RequiredRuntimeException("Except Afcc File Type from '%s'", filename), defRq);
		}
	}
