...
//	}
	...
	public static Sdn ofRootPlane() {
		return of(ItemPath.SD3_INDEX_ALIAS, ItemPath.PAGE_INDEX_ALIAS);
	}
...
//	}
	...
	public Sdn toSdnPlanePage(String page) {
		return Sdn.of(plane(), page);
	}

	public boolean isEmptyPlane() {
		return ItemPath.isAliasIndexOrEmpty(plane());
	}
