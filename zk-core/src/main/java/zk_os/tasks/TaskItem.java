...
//		TaskItemModel.load(threadKey, null);
		...
		FunctionV showData = () -> {
			...
			ZKME.openEditorText("Log..", JOIN.objsByNL(itemModel.getName(), "--", itemModel.model.getTimeAsQDate(), "--", jobState == null || jobState ? itemModel.getValue() : itemModel.getErrorValue()));
		};
