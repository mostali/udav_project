...
//		TaskItemModel.load(threadKey, null);
		...
		FunctionV showData = () -> {
			...
			ZKME.openEditorTextReadonly("Log..", JOIN.objsByNL(itemModel.getName(), "--", itemModel.model.getTimeAsQDate(), "--", jobState == null || jobState ? itemModel.getValue() : itemModel.getErrorValue()));
		};
