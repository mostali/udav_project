...
import mp.utl_odb.tree.trees.TreeCallEE;
import mp.utl_odb.tree.trees.UTreeRest;
...
public class ApiCallPage extends PageSP implements WithLogo, WithAgna, WithHeadRsrc, WithUsrLogo {
	public static final String D3_URLPATH_PREFIX = "$";
	public static final String QUERY_ARG_VAL = "v";

	public ApiCallPage(Window window, SpVM spVM) {
		super(window, spVM);
	}
...
//		path3 = ppiq.path_str(3, null);
		...
		UTree d3 = AppZosCore.TREE_SUBDOMAINS();
