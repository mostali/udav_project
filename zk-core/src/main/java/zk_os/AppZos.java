...
//		return APP.IS_DEBUG_ENABLE;
		return AppZosProps.IS_DEBUG_ENABLE.getValueOrDefault(false);
	}

	public static boolean isPromEnable() {
		return AppZosProps.IS_PROM_ENABLE.getValueOrDefault(false);
	}

	public static boolean isDevEnable() {
		return AppZosProps.IS_DEV_ENABLE.getValueOrDefault(false);
	}
