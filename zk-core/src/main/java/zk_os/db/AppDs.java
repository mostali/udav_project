...
public class AppDs {
	...
	public static String getFnQuartzHsqldb() {
		return FILE_HSQLDB_QZDB == null ? (FILE_HSQLDB_QZDB = Env.RPA_ROOT_APP_DEF() + "/env/" + HSQLDB_QZDB_NAME + "/" + HSQLDB_QZDB_NAME) : FILE_HSQLDB_QZDB;
	}

	public static @NotNull DriverManagerDataSource buildDataSource_App_Sqlite() {
		final DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("org.sqlite.JDBC");
		dataSource.setUrl("jdbc:sqlite:" + AppCoreZos.getAppDbFile());
