...
//	}
	...
	public static boolean isEditorAdminOwner() {
		...
		return user.getRolesListGA().contains(ROLE.GA_ROLE_EDITOR) || SecEnt.isPlaneOwner();
	}


	public static boolean isEditor() {
		WebUsr user = Sec.getUser(null);
		return user == null ? false : user.getRolesListGA().contains(ROLE.GA_ROLE_EDITOR) || SecEnt.isPlaneOwner();
	}
