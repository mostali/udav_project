...
//		LogDirView.removeMeFirst(null);
	...
	protected void init() {
		...
		Predicate<Path> pathArcPredicate = (Path p) -> !GEXT.ARC.has(p);
	...
	public static class MergeableDirView extends DirView implements IZComFadeIO {
		...
		@Override
		public Component newCom() {
			LogDirView.MergeableDirView newInst = RFL.inst0(LogDirView.MergeableDirView.class, false, new Class[]{Path.class, boolean.class}, new Object[]{path(), open});
