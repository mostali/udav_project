...
public interface IZStyle {
    ...
    default IZStyle bgcolor(Object bgColor) {
        return (IZStyle) ZKS.BGCOLOR(comH(), EColor.toColorPropertyValue(bgColor));
    }

    default IZStyle color(Object bgColor) {
        return (IZStyle) ZKS.COLOR(comH(), EColor.toColorPropertyValue(bgColor));
    }
    ...
    default IZStyle applyNiceBg(String fromColor, String toColor) {
        ZKS.applyNiceBg((HtmlBasedComponent) this, fromColor, toColor);
        return this;
    }
    ...
    default IZStyle scale(double v) {
        ZKS.SCALE(comH(), v);
        return this;
    }
