...
public interface IZComExt<T extends XulElement> extends IZCom<T>, IZWin<T> {
	...
	default EscTbx closableByEsc(Component... closeIT) {
	...
	default Img appendImg(Path fileImg) {
		return ADDC.IMG(com(), fileImg);
	}
...
//	void appendError(String msg, NtfEE.NPos postion, Component... ref) {
////		NotifyPanel.View.DEFAULT.show(this, connectRemoteFsFromSwby, NotifyPanel.HideBy.TIMEOUT_SLOW);
////		NotifyPanel.show(this, US.SPLIT.splitFastList(connectRemoteFsFromSwby, "\n"), NotifyPanel.View.DEFAULT, NotifyPanel.HideBy.TIMEOUT_SLOW);
//		NtfEE.LEVEL.ERR.I(msg).closable().position(postion).ref(ref).show();
////		appendHtml("<h6 style='color:red'></h6>");
//	}
...
//	default Bt appendBt(String btLabel, SerializableEventListener serializableEventListener) {
//		Bt component = new Bt(btLabel);
//		com().appendChild(component);
//		component.onClick(serializableEventListener);
//		return component;
//	}
