...
public class LineChart extends Chart {
	...
	public static final String RSRCC_LINECHART = "/_com/charts/linear.html";
	public static final String RSRCC_LINECHARTN = "/_com/charts/linearN.html";
	...
	public static LineChart ofN(ChartType chartType, String id, List<String> labelSet, Map<String, List<Integer>> datasets) {
	...
	public static class MapToStringConverter {
		...
		public static String convertMapToString(Map<String, List<Integer>> map) {
		...
		public static void main(String[] args) {
			...
			Map<String, List<Integer>> exampleMap = MAP.of(
					"label1", ARR.as(1, 5, 7),
					"label2", ARR.as(2, 3, 4)
			);
