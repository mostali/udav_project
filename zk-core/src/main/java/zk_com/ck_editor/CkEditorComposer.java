...
public class CkEditorComposer extends GenericForwardComposer {
	...
	public static final String ZUL_RSRC = "/_com/ck-editor/simple-ck-editor.zul";
...
//			NI.stop("ni");
		...
		cKeditor.setValue(RW.readContent(file, "set data"));
		return cKeditor;
	}
...
//		of.setHeight("20px");
		...
		Window window = Div0.of()._modal()._title(UF.fn(file))._popup()._ovl()._closable()._showInWindow();
