...
public class AdvVideo__WTH extends XulElement implements MediaElement {
	...
	public AdvVideo__WTH() {
	}

	public AdvVideo__WTH(String src) {
		this.setSrc(src);
	}
	...
	public void setSrc(List<String> src) {
		if (!src.equals(this._src)) {
			this._src = src;
			this.smartUpdate("src", new AdvVideo__WTH.EncodedSrc());
		}
	}
	...
	public Object getExtraCtrl() {
		return new AdvVideo__WTH.ExtraCtrl();
	}

	static {
		addClientEvent(org.zkoss.zul.Audio.class, "onStateChange", 1);
	}
