...
public class AdvVideo extends HtmlBasedComponent implements UiLifeCycle, AfterCompose, FileUploadSpecification {
	...
	private static final Logger log = LoggerFactory.getLogger(AdvVideo.class);

	static {
		addClientEvent(AdvVideo.class, ON_FILE_ADD, CE_IMPORTANT);
		addClientEvent(AdvVideo.class, ON_FILE_UPLOAD, CE_IMPORTANT);
		addClientEvent(AdvVideo.class, ON_FILE_DELETE, CE_IMPORTANT);
		addClientEvent(AdvVideo.class, ON_FILES_CLEAR, CE_IMPORTANT);
	}
