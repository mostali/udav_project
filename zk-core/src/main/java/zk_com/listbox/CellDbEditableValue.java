...
public class CellDbEditableValue extends EditableValue {
	...
	public CellDbEditableValue(AbsType vl, Path pathDb, Integer[] xyIndex) {
...
//		ZKS.WIDTH_HEIGHT100(getViewCom());
		...
		ZKE.SKeys.CTRL_S.add(this, event -> onUpdatePrimaryText(getEditCom().getValue()));

	}


	private Long getModelId() {
		Listbox0.SortListitem parent = (Listbox0.SortListitem) getParent().getParent();
		return UST.LONG((String) parent.getAttribute(CN.I));
//		return parent.getColVal(CN.I);
	}
