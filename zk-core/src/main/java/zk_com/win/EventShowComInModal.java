...
public class EventShowComInModal implements SerializableEventListener {
	...
	public EventShowComInModal(Object title, Supplier<HtmlBasedComponent> modalComGetter, boolean... darkTheme) {
		this(title, ZKC.getFirstWindow(), modalComGetter, darkTheme);
	}

	public EventShowComInModal(Object title_cap_com, Component parent, Supplier<HtmlBasedComponent> modalComGetter, boolean... darkTheme) {
