...
//			}
		...
		ZKE.SKeys.ALT_V.add(editCom, event -> onChangeStateToEditableOrLabel(event, false, ((KeyEvent) event).getKeyCode() == 66));
//		ZKE.addEventListenerCtrl(editCom, ZKE.SHORTCUT_STORE_ALT_V, (SerializableEventListener) event -> onChangeStateToEditableOrLabel(event, false, ((KeyEvent) event).getKeyCode() == 66));
