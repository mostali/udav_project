...
public class Tbx extends Textbox implements IZCom {
	...
	public Tbx saveble(boolean... savable) {
		//UC.state(isPersist(), "Writable flag used only for persistence form (with file)");
	...
	public void autoDims() {
		ZKS.initAutoDims(this, this.getValue());
	}

	public Tbx autoWidth() {
		width(ZKS.getAutoWidth_50_100_200(this.getValue(), 1));
		return this;
	}
...
//		widthHeight100 = X.toBoolean(widthHeight100, false);
//		widthHeigh100 = X.toBoolean(widthHeigh100, false);

		if (dimsMode != null) {
			dimsMode.init(this, contentFromFile != null ? contentFromFile.get() : getValue());
		}
//		if (widthHeight100 || widthHeigh100) {
//			ERR.isFalse(widthHeight100 && widthHeigh100, "wrong dims configuration. Except only one [%s|%s]", widthHeight100, widthHeigh100);
//			if (widthHeight100) {
//				setWidthHeight100();
//			} else {
//				ZKS.initAutoDims(this);
//			}
//		}
	...
	public enum DIMS {
		...
		public void init(InputElement com, String value) {
			switch (this) {
				case BYCONTENT:
					ZKS.initAutoDims(com, IT.NN(value));
					break;
				case WH100:
					com.setHeight("100%");
					com.setWidth("100%");
