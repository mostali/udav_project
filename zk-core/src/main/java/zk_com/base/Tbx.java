...
//	private Pare<String, Object> eventBus;
...
//	public Tbx eventBusable(Pare eventBusable) {
//		this.eventBus = eventBusable;
//		return this;
//	}
	...
	public void onChangingAutoWidth(int defWidth) {
		onCHANGING((Event e) -> {
...
//		ZKE.addEventListenerCtrl(this, Events.ON_OK, erializableEventListener) event -> onSubmitTextValue());
	...
	protected String readFileContent() {
		return RW.readString(Paths.get(this.path), "");
	}
...
//				if (eventBus != null) {
//					UEventBus.post(Pare3.of(eventBus.val(), pathFile, value), eventBus.key());
//				}
			}
		}
...
//			ZKI_Custom.infoBottomRightFast(notificationMessage);
		} else {
