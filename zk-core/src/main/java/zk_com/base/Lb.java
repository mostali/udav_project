...
public class Lb extends Label implements IZComExt {
	...
	public static Lb ERR(String msg, Object... args) {
		return (Lb) of(X.f(msg, args)).font_size(22).color(ZKColor.REDS.variants[1]);
	}

	public static Lb WARN(String msg, Object... args) {
		return (Lb) of(X.f(msg, args)).font_size(22).color(ZKColor.BLUES.variants[1]);
	}

	public static Lb INFO(String msg, Object... args) {
		return (Lb) of(X.f(msg, args)).font_size(22).color(ZKColor.GREENS.variants[1]);
	}
