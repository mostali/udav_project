...
public class DdFileUploaderComposer extends GenericForwardComposer implements IUploaderCom {
	...
	public static final String ZUL_WEB_COM_CLIPBOARD_LOADER_CLIPBOARD_LOADER_ZUL = "/_com/dd-file-uploader/dd-file-uploader.zul";
	public static final String ZUL_WEB_COM_CLIPBOARD_LOADER_CLIPBOARD_LOADER_JS = "/_com/dd-file-uploader/dd-file-uploader.js";
...
//			Clients.log(data.toString());
			...
			try {
				do {//
					...
					ZKI.infoSingleLine("Uploaded '%s'", APP.isDebugEnable() ? writedClpImg : UPath.getTwo_ParentWithChild(writedClpImg));

					FunctionV1<Path> callbackSuccess = UMap.getAs(getZulLoaderContext(), AK_SUCCESS_CALLBACK, FunctionV1.class, null);
