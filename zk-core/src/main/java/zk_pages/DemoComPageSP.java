...
import zk_notes.control.maintbx.console.MvelConsolePanel;
import zk_notes.control.maintbx.console.SufdConsole;
...
//		testDnd();
	...
	private void sectionConsole() {
		addHeaderCom("Mvel Console");
		window.appendChild(SufdConsole.getConsolePanel(ARR.EMPTY_MAP));
	}
