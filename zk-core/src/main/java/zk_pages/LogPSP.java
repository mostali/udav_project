...
public class LogPSP extends PageSP {
	...
	public void buildPageImpl() {
		...
		try {
			...
			Integer maxLogMb = (Integer) AFC.PAGES.getStatePathCurentType().getAs("maxLogMb",Integer.class,LOG_VIEW_MAX_MB);

			Supplier<LogHtmlCom> creator = () -> LogHtmlCom.fromFileMaxMb(iGetLogDate, fileLog, maxLogMb, true, LogHtmlCom.getBgColorAttr());
