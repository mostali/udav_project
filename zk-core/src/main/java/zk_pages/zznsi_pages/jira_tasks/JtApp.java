...
public class JtApp {
	...
	public static final String ICO_ISSUE = SYMJ.GLOB_GRID;

	public static final String ICO_USER = SYMJ.USER;
	public static final String ICO_PRIO = SYMJ.LAMP;
	public static final String ICO_TYPE = SYMJ.GLOB_GRID;
	public static final String ICO_STATUS = SYMJ.ARROW_MOVABLE;
	public static final String ICO_COMMENT = SYMJ.ZZZ;
