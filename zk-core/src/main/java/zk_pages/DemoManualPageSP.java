...
@PageRoute(pagename = DemoManualPageSP.PAGENAME, role = ROLE.ANONIM)
public class DemoManualPageSP extends PageSP implements IPerPage {

    public static final String PAGENAME = "@@manual";
    ...
    public void buildPageImpl() {
        ...
        if (part != null) {
            switch (part) {
                case "markup":
                    appendChild(Xml.asRsrcXml("/etc/manual/markup.md"));
                    return;
...
//					L.info("Not found page part {}", part);
        ...
        Div0 separator = Div0.separator(130, EColor.GREEN.nextColor(), 1, "ZNote Manual\n", "class=\"head\"", "style=\"padding-top:50px\"");
