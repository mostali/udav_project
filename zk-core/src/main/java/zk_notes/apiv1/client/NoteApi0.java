...
public class NoteApi0 extends NoteApi {
	...
	@Deprecated
	public NoteApi0() {
		super(APP.MAIN.getAppHost("q.com:8080"), AppZosConfig.SUPER_KEY);
	}
	...
	public static NoteApi0 ofPropOrLocal() {
		return new NoteApi0(APP.MAIN.getAppHost("q.com:8080"), AppZosConfig.SUPER_KEY);
	}

	public static NoteApi0 ofZZN() {
		return new NoteApi0(APP.MAIN.getAppHost("zznote.ru"), APP.APK_SUPER_KEY_DEGAULT);
	}
