...
public class RightControlPanel extends Win0 implements ISpCom {
	...
	public static RightControlPanel findFirst(RightControlPanel... defRq) {
		return ZKCFinderExt.findFirst_inPage0(RightControlPanel.class, true, defRq);
	}
...
//				List<String> allEmojs = SYMJ.getAllEmojs();
			...
			Pare<String, SerializableEventListener> eventShowPopup = Pare.of(Events.ON_MOUSE_OVER, Popup0.openPopupEventWithComLn(lnClean, lnAutoGrid, lnOnBorder, lnShowColor, lnShowEmoji));
