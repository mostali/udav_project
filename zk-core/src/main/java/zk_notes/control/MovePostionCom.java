...
public class MovePostionCom extends Div0 {
	...
	final boolean isBinaryComWoNodeLn;

	public static void show(NodeDir nodeDir, boolean... isBinaryComWoNodeLn) {
		Window window = new MovePostionCom(nodeDir, ARG.isDefEqTrue(isBinaryComWoNodeLn))._showInWindow();
	}
