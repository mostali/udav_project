...
public class NotesSpace extends Div0D implements IReRender {
	...
	public static NotesSpace findFirst() {
		return ZKCFinder.findFirst(NotesSpace.class, false);
	}

	public static Component rerenderFirst() {
//		ZKC.printAll();
		NotesSpace notesSpace = ZKCFinder.rerenderFirst(NotesSpace.class, true);
		return notesSpace;
	}
...
//		window.appendChild(new LeftMenu(Paree3.of(true, false, false)));
