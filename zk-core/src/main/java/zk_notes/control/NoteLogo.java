...
//				ZKR.restartPage();
		...
		if (isAdmin) {
			...
			{ //CONFIG PANEL
				String propName = AppNotesProps.PAGE_PANEL_TASKS_OPENED;
				Supplier<Boolean> openStateCgfPanel = () -> pagetate.hasPropEnable(AppNotesProps.PAGE_PANEL_TASKS_OPENED, false);
...
//					ZKR.restartPage();
			...
			{ //BOTTOM HISTORY PANEL
				String propName = AppNotesProps.PAGE_PANEL_BOTTOM_HISTOTY_PANEL_OPEN;
				Supplier<Boolean> openStateCgfPanel = () -> pagetate.hasPropEnable(AppNotesProps.PAGE_PANEL_BOTTOM_HISTOTY_PANEL_OPEN, false);
