...
//		ZKS.BGCOLOR(this, "#f08080");
	...
	private void appendRight_StopPhrasesPanel() {
		...
		for (Pare3<String, String, String> phrases : pares) {
			...
			DefAction defAction = e -> ZKM_Editor.openEditorWithBtSave(() -> stopPhrasesString, newSaveCallback(tbxKey), Span0.of(tbxKey, btRmList), false);
	...
	private Ln newBtAddNewPhrases() {
		...
		DefAction defAction = e -> ZKM_Editor.openEditorWithBtSave(() -> "new-stop-phrase", newSaveCallback(tbxKey), tbxKey, false);
