...
public class FormState<P> extends SecFileState<P> {
	...
	public class Fields {
		...
		public boolean get_FIXED() {
			return getAs(PK_FIXED, Boolean.class, false);
		}
		public boolean get_FIXED_orTrue() {
			return getAs(PK_FIXED, Boolean.class, true);
		}
...
//					!Events.ON_CLICK.equals(e.getName()) && //
	...
	public static void apply_TopLeft_WidthHeigth_Bgc_Titles(HtmlBasedComponent comTextWin, //
		...
		boolean fixedOrTrue = stateForm.fields().get_FIXED_orTrue();
		if (fixedOrTrue) {
