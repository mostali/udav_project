...
public class FormState<P> extends SecFileState<P> {
	...
	public Boolean isVisibleBody() {
		return getAs(FormState.BODY_VISIBLE, Boolean.class, true);
	}

	public Boolean isNeedOpenIfHide() {
		return getAs(FormState.BODY_OPENIFHIDE, Boolean.class, false);
	}

	public Boolean isToggleBodyBehaviour() {
		return getAs(FormState.BODY_TOGGLE, Boolean.class, false);
	}
...
//		}
	...
	public FormState stateCom(boolean... create) {
		...
		return AppStateFactory.ofComName_orCreate(sdn, formName(), create);
	}
