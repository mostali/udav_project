...
public class NodeEvalAction<N> {
	...
	public static final FunctionIO DEFAULT_OUT_ANY_OBJECT = evaluated -> ZKI.infoEditorDark("" + evaluated + "");
	...
	public NodeEvalAction(NodeDir nodeDir, ENV env, RESULT string) {
		...
		this.evalType = nodeDir.defineNodeType(true);
		this.envType = env;
	}
	...
	public static <T> Pare3<NodeDir, Optional<T>, Object> doEvalNodeAction(NodeDir node, FunctionIO<NodeDir, T> evalFunction, FunctionIO<T, Object> viewFunction) {
