...
public enum NodeEvalType {
	NODE, HTTP, KAFKA, SQL, QZEVAL, JARTASK, SENDMSG, MVEL, GROOVY, PYTHON, SHTASK;
...
//				return SYMJ.MONEY_STATS;
	...
	public String[] toColor() {
		switch (this) {
			...
			case KAFKA:
			case HTTP:
				return UColorTheme.GREEN;
			case QZEVAL:
				return UColorTheme.BLUE;
			case PYTHON:
			case MVEL:
			case GROOVY:
				return UColorTheme.ORANGE;
			case SHTASK:
				return UColorTheme.BLUE;
			case JARTASK:
				return UColorTheme.YELLOW;
			case NODE:
				return UColorTheme.GRAY;
			case SQL:
				return UColorTheme.BLACK;

			default:
				return UColorTheme.WHITE;
	...
	public FunctionT<NodeDir, Object> evalIn(Map... context) {
		return NodeActionIO.in(this, context);
	}

	public FunctionT evalOut(Map... context) {
		return NodeActionIO.out(this,context);
	}
