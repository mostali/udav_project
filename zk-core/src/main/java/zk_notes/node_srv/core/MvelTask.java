...
public class MvelTask<T> {
	...
	public static MvelTask of(NodeDir node0) {
		Map context = new HashMap<>();
		context.put("node", node0);
		return of(node0.nodeDataInjected().nodeData, context);
	}
...
//			return;
//		}
		MvelTask task = MvelTask.of("int c=a+b;return c;", ARR.EMPTY_MAP);
	...
	public static MvelTask of(String code, Map context) {
		return new MvelTask(code, context);
	}
