...
public class JarECS {
	...
	public static class EVAL {
		...
		public static Object doJarCallSyncRest_VALUE(NodeData<NodeDir> nodeData, Object... defRq) {
			...
			return value != null ? value : ARG.throwMsg(() -> X.f("Except not null value from jar call node '%s'", node.nodeId()), defRq);
		}
	}
	...
	public static FunctionIO<NodeDir, Object> evalFunction(TrackMap.TrackId trackId) {
		Component activePushComHolder = ZKC.getFirstWindow();
		FunctionIO<NodeDir, Object> evalFunc = node -> {
