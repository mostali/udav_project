...
public class QzECS {
	...
	public static void runAll(NodeDir srcNode) {
		runAll(srcNode, QzCallMsg.of(srcNode.state().nodeData()));
	}

	public static void runAll(NodeDir srcNode, QzCallMsg qzCallMsg) {
	...
	private static void addJob(Class<? extends Job> jobClass, NodeDir srcNode, Map jobConfigureContext) {
		...
		jobData.put(QzCallMsg.NODEID_SRC, srcNode.nodeId());
