...
//		Map mapQueryContext = TrackMap.getContext(trackId, ARR.EMPTY_MAP);
		Map mapQueryContext = trackId == null ? ARR.EMPTY_MAP : trackId.getContext();
		...
		Function<String, Object> placeholderReolverPct = (gncKey -> UTree.tree(APP.GNC_TREE()).getValue(gncKey, null));
		...
		Function<String, Object> placeholderReolverDogKey = (nodeId) -> {
			...
			String vl = EvalService.evalNodeTracked(innerNodeDir, trackId);
