...
public class LmMenuPicker extends MenuPicker {
	...
	protected static void applyStyle(MenuPicker parent, Div0M menuPanel, SpaceType spaceType) {
...
//		ZKS.ABSOLUTE(parent);
	...
	public LmMenuPicker(Sdn sdn, Collection items, SpaceType spaceType) {
		super(items);
		this.sdn = sdn;
	...
	protected void applyStyleForItem(Ln ln) {
		...
		switch (spaceType) {
			case NODES:
				...
				break;
			case PAGES:
				ANMP.applyPageLink(menu, sdn.cloneKey(eName));
				break;
			case SPACES:
...
//						Component component = event.getTarget();
						NFForm.openForm(nodeDir, component);
						break;
...
//						}
					...
					case SHIFT:
						NFForm.openFormOrCloseToggle(nodeDir);
						break;
