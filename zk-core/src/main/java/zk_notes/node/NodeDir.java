...
public class NodeDir extends SiteDir<FormState> implements INode<NodeDir> {
	...
	protected FormState newAfcState() {
		return AppStateFactory.ofFormName_orCreate(sdnPare(), nodeName());
	}
...
//		return nodeDataInjected == null || ARG.isDefEqTrue(fresh) ? nodeDataInjected = NodeData.of(this).newInjected() : nodeDataInjected;
...
//		return nodeDataInjected == null || ARG.isDefEqTrue(fresh) ? nodeDataInjected = NodeData.of(this).newInjected(trackId) : nodeDataInjected;
...
//	public NodeData inject(TrackMap.TrackId trackId, boolean... fresh) {
	...
	/// /		return nodeDataInjected INode.super.inject(fresh);
//		return nodeDataInjected == null || ARG.isDefEqTrue(fresh) ? nodeDataInjected = INode.super.inject(fresh) : nodeDataInjected;
//	}

	//	public NodeData nodeDataNoInjected() {
//		return NodeData.of(this);
//	}
	//
	//
