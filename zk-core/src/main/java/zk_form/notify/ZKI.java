...
//					break;
				...
				case MODAL_BW:
					...
					break;
				case MODAL_JSON_BW:
					ZKME.openEditorJson(title(title, Level.INFO), msg.toString(), true);
//					ZKI.infoEditorJson(msg, true);
					break;
				case MODAL_JSON:
					ZKME.openEditorJson(title(title, Level.INFO), msg.toString(), false);
					break;
				case MODAL_HTML:
...
//		Clients.alert(ERR.getMessageWithType(err));
	...
	public static Pare<Window, Tbxm> infoEditorBw(Path file, EXT type) {
		return ZKME.openEditorText(file, EXT.JSON == type, true);
	}
	...
	public static XulElement infoEditorJson(Object singleJson, boolean linent_many_parts) {
		...
		return ZKME.openEditorWithBtSave(stringSupplier, saveCallback, null, false);
	}

	public static Pare<Window, Tbxm> errorEditorBw(CharSequence msg, Object... args) {
		return ZKME.openEditorTextReadonly(SYMJ.WARN + " Error", X.f(msg, args), true);
	}

	public static Pare<Window, Tbxm> infoEditorBwTitle(String title, CharSequence msg, Object... args) {
		return ZKME.openEditorTextReadonly(SYMJ.INFO_SIMPLE + " " + title, X.f(msg, args), true);
	}

	public static Pare<Window, Tbxm> infoEditorBw(CharSequence msg, Object... args) {
		return ZKME.openEditorTextReadonly(SYMJ.INFO_SIMPLE + " Info", X.f(msg, args), true);
	}

	public static Pare<Window, Tbxm> infoEditorBw(Object title_cap_com, CharSequence msg, Object... args) {
		return ZKME.openEditorTextReadonly(title_cap_com, X.f(msg, args), true);
	}
