...
//		Clients.alert(ERR.getMessageWithType(err));
	...
	public static void infoEditorHtmlView(Object title_cap_com, String xmlData, boolean... darkTheme) {
		ZKM.showModal(title_cap_com, Xml.asXml(xmlData), darkTheme);
	}

	public static void infoEditorHtmlView(Object title_cap_com, String xmlData, String[] wh, boolean... darkTheme) {
		ZKM.showModal(title_cap_com, Xml.asXml(xmlData), wh, darkTheme);
	}
}
