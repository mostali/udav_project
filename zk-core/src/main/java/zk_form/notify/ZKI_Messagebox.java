...
public class ZKI_Messagebox {
	...
	public static void showMessageBoxBlueYN(String title, String message, Function<Boolean, Void> handler) {
		Messagebox.show(message, X.toString(title, "Confirmation.."), Messagebox.YES | Messagebox.NO, Messagebox.QUESTION, (SerializableEventListener<Event>) evt -> {
			try {
