...
public class Tbx2_CfrmSerializableEventListener implements SerializableEventListener {
	...
	public static Mi toMenuItemComponent(String miLabel, String winTitle, String[] initValues, String[] placeholders, Function2<String, String, Object> handlerInputValues) {
