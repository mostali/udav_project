...
public class Tbx_CfrmSEL implements SerializableEventListener {
	...
	public static Mi toMenuItemComponent(Object title_cap_com, String label, String initValue, String placeholder, Function<String, Object> handlerInputValue) {
		Mi lb = new Mi(label);
		lb.onCLICK(new Tbx_CfrmSEL(title_cap_com, initValue, placeholder, handlerInputValue));
		return lb;
	}
	...
	public static void openInModal(Function<String, Object> handlerInputValue1) {
		Tbx_CfrmSEL tbxCfrmSerializableEventListener = new Tbx_CfrmSEL(null, null, null, handlerInputValue1);
