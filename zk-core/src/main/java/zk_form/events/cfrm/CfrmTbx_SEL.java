...
public class CfrmTbx_SEL implements SerializableEventListener {
	...
	public static Mi toMenuItemComponent(Object title_cap_com, String label, String initValue, String placeholder, Function<String, Object> handlerInputValue) {
		Mi lb = new Mi(label);
		lb.onCLICK(new CfrmTbx_SEL(title_cap_com, initValue, placeholder, handlerInputValue));
		return lb;
	}
	...
	public static void openInModal(Function<String, Object> handlerInputValue1) {
		CfrmTbx_SEL tbxCfrmSerializableEventListener = new CfrmTbx_SEL(null, null, null, handlerInputValue1);
