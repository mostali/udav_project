...
public class CfrmTbx_GrepSEL extends CfrmTbx_SEL {

	public CfrmTbx_GrepSEL(String title, String initText, @NotNull Function handlerInputValue) {
	...
	public static Mi toMenuItemComponent(Object title_cap_com, Path path, String initValue, Function<List<String>, Path>... successGrepCallback) {
		...
		Mi menuItemComponent = CfrmTbx_GrepSEL.toMenuItemComponent(title_cap_com, label, initValue, "Search phrase", (String s) -> {
			try {
