...
public class Grep_CfrmSEL extends Tbx_CfrmSEL {

	public Grep_CfrmSEL(String title, String initText, @NotNull Function handlerInputValue) {
	...
	public static Mi toMenuItemComponent(Object title_cap_com, Path path, String initValue, Function<List<String>, Path>... successGrepCallback) {
		...
		Mi menuItemComponent = Grep_CfrmSEL.toMenuItemComponent(title_cap_com, label, initValue, "Search phrase", (String s) -> {
			try {
