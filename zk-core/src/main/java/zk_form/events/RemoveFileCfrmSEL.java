...
public class RemoveFileCfrmSEL implements SerializableEventListener {

	public static Mi toMenuItemComponent(String file, DefAction successCallback) {
		Mi lb = new Mi(ANI.DELETE_ENTITY + " Remove file '" + UF.fn(file) + "'");
		lb.onCLICK(new RemoveFileCfrmSEL(file, successCallback));
		return lb;
	}
