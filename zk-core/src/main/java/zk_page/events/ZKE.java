...
public class ZKE {
	...
	public enum SKeys {
		...
		private final String shortcut_keys;

		public void add(XulElement xulElement, SerializableEventListener eventListener) {
			ZKE.addEventListenerCtrl(xulElement, shortcut_keys, eventListener);
		}
	}
...
//	public static final String SHORTCUT_STORE_ALT_Q = "@q";
	...
	public static void addEventListenerCtrl(XulElement xulElement, String shortcut_keys, EventListener eventListener) {
		xulElement.setCtrlKeys(shortcut_keys);
		xulElement.addEventListener(Events.ON_CTRL_KEY, eventListener);
	}

	public static void addEventListenerCtrl_DEBUG(XulElement xulElement, EventListener eventListener, ZKEventKey ctrlKeys, String... events) {
		addEventListenerCtrl_DEBUG(xulElement, eventListener, ctrlKeys.toString(), events);
	}

	public static void addEventListenerCtrl_DEBUG(XulElement xulElement, EventListener eventListener, String ctrlKeys, String... events) {
		List<String> eventsValues = createEvents(events, ARR.EMPTY_ARGS);
