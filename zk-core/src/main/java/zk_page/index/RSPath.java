...
//				a
	...
	public String toPlaneLink(String planeName, QueryArg... withArgs) {
		switch (this) {
			case PLANE:
				IT.state(!ItemPath.isPlaneAliasIndexOrEmpty(planeName), "why here plane '%s'", planeName);
	...
	public String toPageLink(String plane, String pagename, String other_path, QueryArg... withArgs) {
		switch (this) {
			case PAGE:
				...
				String appHostWithPlane = ItemPath.isPlaneAliasIndexOrEmpty(plane) ? APP.HOST.getAppHostWithProtocol() : APP.HOST.getAppHostWithPlane(plane);
...
//	}
	public static void toPage_Redirect_CheckNoIndex(String planeName, String pagename, QueryArg... args) {
		if (ItemPath.PAGE_INDEX_ALIAS.equals(pagename)) {
	...
	public static void toPlane_Redirect_CheckNoIndex(String planeName, QueryArg... args) {
		if (ItemPath.PLANE_INDEX_ALIAS.equals(planeName)) {
