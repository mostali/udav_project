...
//	}
	...
	public static void toPageItem_OWin(NodeID nodeID, QueryArg... args) {
		ZKR.openWindow800_1200(toPageItem(nodeID, args));
	}

	public static void toPageItem_Redirect(NodeID nodeID, QueryArg... args) {
		toRedirect(toPageItem(nodeID, args), false);
	}

	public static String toPageItem(NodeID nodeID, QueryArg... args) {
		Pare<String, String> sdn = nodeID.sdn();
		return toPage(sdn.key(), sdn.val() + "/" + nodeID.nodeName(), args);
	}

	public static void toPage_Redirect(Pare sdn, QueryArg... args) {
		toPage_Redirect((String) sdn.key(), (String) sdn.val(), args);
	}

	public static void toPage_Redirect(String planeName, String pagename, QueryArg... args) {
		toRedirect(toPage(planeName, pagename, args), false);
	}

	public static void toRedirect(String url, boolean blank) {
		ZKR.redirectToLocation(url, false);
	}

	public static String toPage(Pare sdn, QueryArg... args) {
		return toPage((String) sdn.key(), (String) sdn.val(), args);
	}
