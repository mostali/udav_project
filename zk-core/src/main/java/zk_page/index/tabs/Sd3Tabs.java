		...
		for (Component child : tabs.getChildren()) {
			...
			tab0.addEventListener(Events.ON_DROP, e -> {
				...
				ZKI_Quest.showMessageBoxBlueYN("Moving page", msg, (yes) -> {
					...
					NFTrans.movePageToSd3(movedPageSdn, targetSd3);
