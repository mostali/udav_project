...
import zk_os.walkers.FormsWalker;
...
//			ANM.applyMenu_FormFileItem(menu, nodeDir);
			ANM.applyFormLink(menu, nodeDir);
	...
	public static class FormTabpanel0 extends Tabpanel0 {
		...
		public FormTabpanel0(NodeDir nodeDir) {
			...
			this.tab0 = Tab0.of(new Lb(nodeDir.nodeName()).attr(NodeID.KEY, nodeDir.id()));
		}
		...
		public void init() {
			...
			onEventSelect((e) -> {
				...
				appendChildLazyTabContent(new FormView(getTab0(), nodeDir));
