...
public class IndexTabsPSP extends PageSP implements IPerPage, IZState, WithLogo, WithMainTbx {
...
//	public static final String SK_VERTICAL_TABS = "Vertical Tabs";
	...
	public void buildPageImpl() {
		...
		AppPageEvents.applyEvent_EditPageProps(menu, getPageState().pathFc());
...

		{
			...
			Function2<String, String, Object> successCallback = (t1, t2) -> {
				FormState pageState = FormState.ofPageState_orCreate(Sdn.of(t1.trim(), t2.trim()), true);
				ZKR.restartPage();
				return null;
			};
