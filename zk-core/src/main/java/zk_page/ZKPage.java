...
public class ZKPage {
	...
	public static void renderHeadRsrcs(IHeadRsrc... headRsrcs) {
	...
	public static void renderHeadPage_Rsrc(String path) {
		...
		pageCtrl.addBeforeHeadTags(EHtml5.script.with(js));
	}
