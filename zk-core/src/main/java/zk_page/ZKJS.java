...
public class ZKJS {
	...
	public static void setAction_ShakeEffect(XulElement pnl) {
...
//	}
	...
	public static void eval_timout(String func, int ms) {
		eval(ZKJS.js_setTimeout(func, ms));
	}

	public static void openWindow800_1200(String url) {
		openWindow(url, "800", "1200", true, true, true);
	}

	public static void openWindow(String url, String height, String width, boolean location, boolean scrollbars, boolean status) {
