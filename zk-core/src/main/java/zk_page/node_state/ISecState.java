...
public interface ISecState {
	...
	public static void checkIsAllowedViewOr403(SecFileState formState) {
		if (!formState.isAllowedAccess_View_Edit(true)) {
			throw StatusException.C403("access denied");
		}
	}

	public static void checkIsAllowedEditOr403(SecFileState formState) {
	...
	public default List<String> getSecEditList() {
		return SPLIT.allByComma(entityState().get(SECE, ""));
	}

	public default List<String> getSecViewList() {
	...
	public default boolean isAllowedAccess_Edit() {
