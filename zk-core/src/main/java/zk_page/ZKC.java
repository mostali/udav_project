...
public class ZKC {
	...
	public static Window getFirstWindow(Window... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("First window not found"), defRq);
	}
...
//		total.incrementAndGet();
	...
	public static Desktop getFirstDesktop(Desktop... defRq) {
		...
		return ARG.throwMsg(() -> X.f("First Page not found"), defRq);
	}
	...
	public static <T> T removeMeFirst(Class<T> clazz, boolean recursive_or_first, T... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Except first component for removeMeFirst"), defRq);
	}
