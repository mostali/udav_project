...
//	}
	...
	public static FunctionV2<String, String> getFuncWriteState(FormState state, ZKI.ViewType viewType, Integer... errMode0_1toOk_2okErr) {
	...
	public static FunctionV2<String, String> getFuncWriteState(Component com, FormState state, ZKI.ViewType viewType, Integer... errMode0_1toOk_2okErr) {
