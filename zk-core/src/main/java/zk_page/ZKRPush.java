...
//		checkWebType(type);
	...
	public static FunctionV2<String, String> getFuncWriteState(NodeDir node, ZKI.Type type) {
		return getFuncWriteState(node.state(), type);
	}

	public static FunctionV2<String, String> getFuncWriteState(FormState state, ZKI.Type type) {
	...
	public static FunctionV2<String, String> getFuncWriteState(Component com, FormState state, ZKI.Type type) {
