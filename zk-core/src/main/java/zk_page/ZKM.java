...
public class ZKM {
    ...
    public static final String[] WH100_MIN = {"100%", "min"};
    public static final String[] WH90_MIN = {"90%", "min"};
...
//		w.getCaption().appendChild(new Bt("+"));
        ...
        ZKSWidth.applyWidthHeight(w,wh);

        w.addEventListener(Events.ON_CANCEL, (SerializableEventListener) event -> w.detach());
