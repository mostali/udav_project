...
//	public static final String[] BLUE = AR.of("", "", "", "", "", "", "", "");
	...
	public static void WIDTH_WIN_Content(Window window, Object win_px_pct) {
	...
	public static void PADDING_TOP_WIN(Window window, Object win_px_pct, Object content_px_pct) {
	...
	public static void MARGIN_TOP_WIN(Window window, Object win_px_pct, Object content_px_pct) {
	...
	public static <C extends HtmlBasedComponent> C MARGIN(C com, Object t_px_pct, Object r_px_pct, Object b_px_pct, Object l_px_pct) {
		return applyStylePropertyPxPct(com, "margin", X.f("%s %s %s %s", toPxPct0(r_px_pct), toPxPct0(t_px_pct), toPxPct0(b_px_pct), toPxPct0(l_px_pct)));
	}
	...
	public static boolean applyProp(HtmlBasedComponent com, Map<String, Object> props, String prop) {
		...
		switch (prop) {
			...
			case "height":
				...
				return true;
			case "title":
				com.setTooltiptext((String) props.get("title"));
				return true;
			case "titlex":
				Object titlex = props.get("titlex");
				if (titlex != null) {
					applyProp_Titlex_WithTimeout(com, titlex, 5_000);
				}
				return true;
			default:
...
//			ZKJS.setAction_HideEffect(first, 1000);
	...
	public static <C extends HtmlBasedComponent> C OVERFLOW(C com, Integer auto_hidden_overlay_scroll) {
		if (auto_hidden_overlay_scroll == null) {
			return rmStyleAttr(com, "overflow");
		} else if (!(auto_hidden_overlay_scroll instanceof Number)) {
			return addStyle(com, "overflow:" + auto_hidden_overlay_scroll.toString());
		}
		int valInt = ((Number) auto_hidden_overlay_scroll).intValue();
		String value;
		switch (valInt) {
			case 0:
				value = "auto";
