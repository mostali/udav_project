...
//		ZKS.addStyleAttr(window, "width", win_px_pct == null ? null : toPxPct(win_px_pct));
	...
	public static void applyNiceBg(HtmlBasedComponent menuPanel, String fromColor, String toColor) {
		ZKS.BOX_SHADOW(menuPanel, "0 4px 12px rgba(0,0,0,0.15)");
		ZKS.BG(menuPanel, X.f_("linear-gradient(135deg, %s, %s)", fromColor, toColor));
	}
