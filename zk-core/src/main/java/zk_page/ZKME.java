...
//		}
	...
	public static Pare<Window, Tbxm> openEditorJson(Object title, Path content, boolean... darkTheme) {
	...
	public static Pare<Window, Tbxm> openEditorTextReadonly(Object title, String content, boolean... darkTheme) {
		Tbxm modalCom = (Tbxm) new Tbxm(content, Tbx.DIMS.WH100);
		return Pare.of(ZKM.showModal(title, modalCom, ZKC.getFirstWindow(), darkTheme), modalCom);
	}
...
//		modalCom.setVflex("min");
	...
	public static Window openEditorLog(Object title, String rsltOut) {
		LogHtmlCom logHtmlCom = LogHtmlCom.fromLines(LogGetterDate.buildByFormat(AppZosProps.APR_LOG_DATE_FORMAT.getValueOrDefault()), SPLIT.allByNL(rsltOut));
