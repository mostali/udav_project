...
//		}
    ...
    public static Pare<Window, Tbxm> text(String title, Path content, boolean saveable, boolean... darkTheme) {
        ...
        return Pare.of(ZKM.showModal(title, modalCom, ZKC.getFirstWindow(), ZKM.WH100_MIN, darkTheme), modalCom);
    }
    ...
    public static Pare<Window, SeTbxm> html(String title, Path content, boolean saveable) {
        ...
        return Pare.of(ZKM.showModal(title, modalCom, ZKC.getFirstWindow(), ZKM.WH100_MIN), modalCom);
    }
    ...
    public static Window log(Object title, String content, String... logFormatOrDefault) {
        String logFormat = ARG.toDefOrGet(AppZosProps.LOG_DATE_FORMAT::getValueOrDefault, logFormatOrDefault);
        LogHtmlCom logHtmlCom = LogHtmlCom.openWithLines(LogGetterDate.buildByFormat(logFormat), SPLIT.allByNL(content));
        return ZKM.showModal(title, logHtmlCom, ZKM.WH90_MIN);
    }
}
