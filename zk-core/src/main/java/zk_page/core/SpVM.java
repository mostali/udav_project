...
//	public transient TestService testService;
	...
	public PageState pageState() {
		return AppStateFactory.ofPageName_orCreate(SpVM.get().sdn());
	}
	...
	public void afterComposeImpl(@ContextParam(ContextType.VIEW) Window window) {
		...
		if (L.isInfoEnabled()) {
			L.info(ZKR.getClientIpAddress() + SYMJ.ARROW_RIGHT_SPEC + Sec.getUserNameOrAnonim() + SYMJ.ARROW_RIGHT_SPEC + sdn().toStringPath() + SYMJ.ARROW_RIGHT_SPEC);
		}
