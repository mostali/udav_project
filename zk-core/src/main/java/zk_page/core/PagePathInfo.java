...
public class PagePathInfo implements Serializable {
	...
	@Deprecated
	public Pare<String, String> sdnHybryd() {
		PagePathInfo ppi = SpVM.get().ppi();
		return Pare.of(ppi.subdomain3Rq(), ppi.pagename0());
	}

	public Pare<String, String> sdnRq() {
		PagePathInfo ppi = SpVM.get().ppi();
		return Pare.of(ppi.subdomain3Rq(), ppi.pagenameRq());
	}
