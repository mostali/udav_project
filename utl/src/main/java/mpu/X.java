...
//		System.out.println(t);
	...
	//debug
	public static Object d(Object obj, String msg, String... exitMsg) {
		if (X.notEmpty(msg)) {
			p(" >>>d " + msg + " <<< ");
		}
		p(obj);
		if (ARG.isDef(exitMsg)) {
			exit(exitMsg);
		}
		return null;
	}
	...
	public static String toStringSE(Object label, int len) {
		String s = label + "";
		return STR.toStringSE(s, len, s);
	}
	...
	public static String toString0(InputStream inputStream, String... defRq) {
		try {
			...
			return ARG.throwMsg(new RequiredRuntimeException(e, "Error read InputStream. Cause:%s"), defRq);
		}
	}
