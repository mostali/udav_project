...
//	}
	...
	public static long sizeOfLines(Path path, Long... defRq) {
		return Files.isRegularFile(path) ? UFS.sizeLines(path) : ARG.toDefThrowMsg(() -> X.f("Error read file size '%s' size", path), defRq);
	}
	...
	public static String toStringFrom(InputStream inputStream, String... defRq) {
		try {
	...
	//	public static void exitp(Object obj) {
//		p(obj);
//		Sys.exit();
//	}
