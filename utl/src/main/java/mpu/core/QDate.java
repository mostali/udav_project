...
public class QDate extends Date {
	...
	public static Date toDateWithManlyMonth(Integer year, Integer month, Integer day, Integer hour, Integer minutes, Integer seconds, Integer millis) {
...
//				m2hour(), m2minutes(), m2seconds());
	...
	public LocalDateTime toLocalDateTime(ZoneId... zoneId) {
		LocalDateTime localDateTime = millis == null ? LocalDateTime.of(year, month, day, hour, minutes, seconds) : LocalDateTime.of(year, month, day, hour, minutes, seconds, millis);
