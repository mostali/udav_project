...
public class MDate {
	...
	public static QDate parseStringToQDate(String input, boolean strictPrimaryZero, QDate... defRq) {
		...
		return dateStringPare.hasKey() ? QDate.of(dateStringPare.key()) : ARG.throwMsg(() -> dateStringPare.val(), defRq);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(parseStringToDate0("nh31", false)); // Sun Jan 01 00:00:00 ... 2025
		X.exit(nowStr()); // Sun Jan 01 00:00:00 ... 2025
