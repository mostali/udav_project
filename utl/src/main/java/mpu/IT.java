...
public class IT {
	...
	public static <T> Collection<T> hasLength(Collection<T> checkable, long length, Object... message) {
		...
		throw new CheckException(ARG.isNotDef(message) ? X.f("Checked collection length except minimal Length(%s)==Collection(%s)", length, checkable.size()) : STR.formatAll(message));
	}
	...
	public static <T> T[] hasLength(T[] checkable, long length, Object... message) {
		...
		throw new CheckException(ARG.isNotDef(message) ? X.f("Checked array length except minimal Length(%s)==Array(%s)", length, checkable.length) : STR.formatAll(message));
	}
