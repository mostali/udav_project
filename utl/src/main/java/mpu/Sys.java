...
//		X.exit(execRq);
//		Sys.exec_UnsafeSpace("ssh ditts.aleksandr@fk-eb-ref-dev-mdm-redos.otr.ru tail -100 /opt/tomcat-9/logs/catalina.out");
	}
...
//		processBuilder.inheritIO();
		...
		if (throwIfHasError && exitCode != 0) {
			throw new ExecRuntimeException(msg, new CleanMessageRuntimeException(JOIN.allByNL(results)));
		}
