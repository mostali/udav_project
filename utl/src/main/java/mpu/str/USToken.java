...
//		P.exit(two("7ta", "t"));
	...
	private static void testTwoPredicate() {
		IT.state(Arrays.equals(two("7t", ISDIGIT), new String[]{"7", "t"}), "7t");
		IT.state(Arrays.equals(two("7", ISDIGIT), new String[]{"7", ""}), "7");
		IT.state(Arrays.equals(twoFromEnd("t7", ISDIGIT), new String[]{"t", "7"}), "t7");
		IT.state(Arrays.equals(twoFromEnd("7", ISDIGIT), new String[]{"", "7"}), "7");
		IT.state(Arrays.equals(twoFromEnd("7t", ISDIGIT.negate()), new String[]{"7", "t"}), "!7t");
...
//		U.p(UC.isEq(lastRegex("a.b.c", "\\."), "c", "lastRegex error"));//c
	...
	public static String[] twoFromEnd(String str, Predicate test, String[]... defRq) {
