...
//		String[] strings = twoByPos("", 0, null);
		...
		U.d(TKN.twoByPos("7t", 0), "0"); // [ "", "t"]
		U.d(TKN.twoByPos("7t", 1), "1"); // [ "7", ""]
		U.d(TKN.twoByPos("7t", 2, null), "2"); // null

		U.d(TKN.twoByLen("7t", 0), "000"); // [ "", "7t"]
		U.d(TKN.twoByLen("7t", 1), "111"); // [ "7", "t"]
		U.d(TKN.twoByLen("78t", 1), "1118-1-78t"); //  [ "7", "8t"]
		U.d(TKN.twoByLen("78t", 2), "1118-2-78t"); //  [ "78", "t"]
		U.d(TKN.twoByLen("78t", 3), "1118-3-78t"); //  [ "78t", ""]
		U.d(TKN.twoByLen("7t", 2), "222"); // [ "7t", ""]
		U.d(TKN.twoByLen("7t", 3, null), "333"); // null
...
//		U.p(UC.isEq(lastRegex("a.b.c", "\\."), "c", "lastRegex error"));//c
	...
	public static String[] two(String str, String splitDelStr, boolean greedy, String[]... defRq) {
		...
		return ARG.throwErr(new RequiredRuntimeException("Pattern '%s' need delimiter '%s'", str, splitDelStr), defRq);
	}
