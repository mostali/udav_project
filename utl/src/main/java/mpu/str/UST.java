...
public class UST {
	...
	public static void main(String[] args) {
		String str = RW.readContent(Paths.get("/home/dav/pjm/pt.sql"));
...
//	}
	...
	public static Path PATH(String str, Path... defRq) {
		try {
			...
			return ARG.toDefThrow(new RequiredRuntimeException("Parse path '%s' error with. Cause:%s", str, e.getMessage()), defRq);
		}
	}

	public static GsonMap GSON(String str, GsonMap... defRq) {
		try {
			return GsonMap.of(str);
		} catch (Exception e) {
			return ARG.toDefThrow(new RequiredRuntimeException("Parse json with cause:%s\n%s", e.getMessage(), str), defRq);
		}
	}
