...
public class UST {
    ...
    public static void main(String[] args) {
        ...
        List<String> allGroup = IRegex.findGroups(str, URx.PT_PLH_DOUBLE_ROUND);
        P.exit(allGroup);
    }
    ...
    public static <N extends Number & Comparable> N NUM(String str, String pfx, N[] minMax, N... defRq) {
        try {
            String arg = STR.removeStart(str, pfx);
    ...
    public static Integer INT(String s, Integer... defRq) {
        try {
            ...
            return ARG.throwErr(() -> new RequiredRuntimeException("Wrong INTEGER from string '%s'", s), defRq);
        }
    }
    ...
    public static <T> T strToExt(CharSequence seq, String checkMethod_StrTo, Class<T> clazz, T... defRq) {
        ...
        try {
            ...
            } else if (clazz == QDelay.class) {
                return (T) QDelay.ofShortPattern(str, (QDelay[]) defRq);
            }
...
//	public static <T> T strTo(CharSequence seq, String checkMethod_StrTo, Class<T> clazz, T... defRq) {
        ...
        try {
            ...
            if (clazz == String.class) {
                ...
                return str.isEmpty() ? (T) Collections.EMPTY_SET : (T) new HashSet(SPLIT.allByNL(str));
            }
    ...
    public static String URL(String url, String... defRq) {
        try {
            new URL(url);
            return url;
    ...
    public static URL URL0(String url, URL... defRq) {
        try {
            return new URL(url);
        } catch (MalformedURLException ex) {
            if (ARG.isDef(defRq)) {
    ...
    public static Date DATE(String str, String format, Date... defRq) {
        try {
            ...
            return ARG.throwErr(new RequiredRuntimeException(e, "Parse date '%s' error with format '%s'", str, format), defRq);
        }
    }
    ...
    public static Path PATH(String str, Path... defRq) {
        try {
            ...
            return ARG.throwErr(new RequiredRuntimeException(e, "Parse path '%s' error.", str), defRq);
        }
    }
    ...
    public static JsonArray JSONARRAY(String jsonArray, JsonArray... defRq) {
        try {
            ...
            return ARG.throwErr(() -> ex instanceof RequiredRuntimeException ? (RequiredRuntimeException) ex : new RequiredRuntimeException(ex, "Error parse JsonArray with json: %s", jsonArray), defRq);
        }
    }
