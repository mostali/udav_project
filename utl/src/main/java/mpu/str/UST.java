...
public class UST {
	...
	public static <T> T strToExtType(CharSequence seq, Class<T> clazz, T... defRq) {
		return strToExtType(seq, null, clazz, defRq);
	}

	public static <T> T strToExtType(CharSequence seq, String checkMethod_StrTo, Class<T> clazz, T... defRq) {
...
//	public static <T> T strTo(CharSequence seq, String checkMethod_StrTo, Class<T> clazz, T... defRq) {
	...
	public static Date DATE(String str, String format, Date... defRq) {
		try {
			...
			return ARG.throwMsg(new RequiredRuntimeException(e, "Parse date '%s' error with format '%s'", str, format), defRq);
		}
	}
	...
	public static Path PATH(String str, Path... defRq) {
		try {
			...
			return ARG.throwMsg(new RequiredRuntimeException(e, "Parse path '%s' error.", str), defRq);
		}
	}
