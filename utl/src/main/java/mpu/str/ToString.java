...
public class ToString {
	...
	public static String toNiceString(Collection val, String verticalDelimetr) {
		String line = val == null ? "null" : (String) val.stream().map(X::toString).collect(Collectors.joining(STR.NL + X.toString(verticalDelimetr, "") + (X.empty(verticalDelimetr) ? "" : STR.NL), STR.NL, STR.NL));
	...
	public static String toStringSE(String str, int count) {
		return STR.substrStartEndInsert(str, count, count, " ... ", str);
	}
