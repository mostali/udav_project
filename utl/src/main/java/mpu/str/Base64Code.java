//package mpu.str;/*
// * $Id: Base64.java 8077 2007-08-27 20:15:25Z aperepel $
// * --------------------------------------------------------------------------------------
...
//
//	/** Preferred encoding. */
//	public static final Charset PREFERRED_ENCODING = StandardCharsets.UTF_8;
//
...
//		return encodeToChar(sArr, sArr != null ? sArr.length : 0, lineSep);
//	}
//
//	/**
//	 * Encodes a raw byte array into a BASE64 <code>char[]</code> representation i accordance with RFC 2045.
//	 * @param sArr    The bytes to convert. If <code>null</code> or length 0 an empty array will be returned.
//	 * @param size    The count of bytes witch will be use as buffer length
//	 * @param lineSep Optional "\r\n" after 76 characters, unless end of file.<br> No line separator will be in breach of RFC 2045 which specifies max 76 per line
//	 *                but will be a little faster.
//	 * @return A BASE64 encoded array. Never <code>null</code>.
//	 */
//	public static char[] encodeToChar(byte[] sArr, int size, boolean lineSep) {
//		// Check special case
//		int sLen = sArr != null ? size : 0;
//		if (sLen == 0) {
//			return new char[0];
//		}
//
...
//	 * @return The Base64-encoded object
//	 * @see Base64Code#GZIP
//	 * @see Base64Code#DONT_BREAK_LINES
//	 * @since 2.0
//	 */
...
//			b64os = new Base64Code.OutputStream(baos, ENCODE | dontBreakLines);
//
//			// GZip?
//			if (gzip == GZIP) {
...
//		} // end try
//		catch (UnsupportedCharsetException uue) {
...
//			ByteArrayOutputStream baos = null;
//			GZIPOutputStream gzos = null;
//			Base64Code.OutputStream b64os = null;
//
//			try {
...
//
//	/**
//	 * Метод-клон {@link Base64Code#decodeFast}, только работает с CharSequence
//	 * @param sArr The source array. Length 0 will return an empty array. <code>null</code> will throw an exception.
//	 * @return The decoded array of bytes. May be of length 0.
//	 */
//	public static byte[] decodeFast(CharSequence sArr) {
//		// Check special case
...
//		while (sIx < eIx && IA[sArr.charAt(sIx)] < 0) {
//			sIx++;
//		}
//
//		// Trim illegal chars from end
//		while (eIx > 0 && IA[sArr.charAt(eIx)] < 0) {
//			eIx--;
//		}
//
//		// get the padding count (=) (0, 1 or 2)
//		int pad = sArr.charAt(eIx) == '=' ? sArr.charAt(eIx - 1) == '=' ? 2 : 1 : 0;  // Count '=' at end.
//		int cCnt = eIx - sIx + 1;   // Content count including possible separators
//		int sepCnt = sLen > 76 ? (sArr.charAt(76) == '\r' ? cCnt / 78 : 0) << 1 : 0;
//
...
//			int i = IA[sArr.charAt(sIx++)] << 18 | IA[sArr.charAt(sIx++)] << 12 | IA[sArr.charAt(sIx++)] << 6 | IA[sArr.charAt(sIx++)];
//
//			// Add the bytes
//			dArr[d++] = (byte) (i >> 16);
//			dArr[d++] = (byte) (i >> 8);
...
//		Base64Code.OutputStream bos = null;
//
//		try {
//			bos = new Base64Code.OutputStream(new BufferedOutputStream(new FileOutputStream(filename)), ENCODE);
...
//
//		try {
//			bos = new Base64Code.OutputStream(new BufferedOutputStream(new FileOutputStream(filename)), DECODE);
...
//		byte[] decodedData;
//		Base64Code.InputStream bis = null;
//
//		try {
...
//
//			// Open a stream
//			bis = new Base64Code.InputStream(new BufferedInputStream(new FileInputStream(file)), DECODE);
//
//			// Read until done
...
//
//			// Open a stream
//			bis = new Base64Code.InputStream(new BufferedInputStream(new FileInputStream(file)), ENCODE);
//
//			// Read until done
//			while ((numBytes = bis.read(buffer, length, 4096)) >= 0) {
//				length += numBytes;
...
//
//	/**
//	 * A {@link Base64Code.InputStream} will read data from another <tt>InputStream</tt>,
...
//
//		/**
//		 * Constructs a {@link Base64Code.InputStream} in DECODE mode.
...
//
//		/**
//		 * Constructs a {@link Base64Code.InputStream} in either ENCODE or DECODE mode.
//		 * <p/>
//		 * Valid options:
//		 * <p/>
//		 * <pre>
...
//		 * @param in      the <tt>InputStream</tt> from which to read data.
//		 * @param options Specified options
//		 * @see Base64Code#ENCODE
//		 * @see Base64Code#DECODE
//		 * @see Base64Code#DONT_BREAK_LINES
//		 * @since 2.0
//		 */
...
//
//	/**
//	 * A {@link Base64Code.OutputStream} will write data to another <tt>OutputStream</tt>,
//	 * given in the constructor, and encode/decode to/from Base64 notation on the
//	 * fly.
//	 * @see Base64Code
//	 * @since 1.3
...
//
//		/**
//		 * Constructs a {@link Base64Code.OutputStream} in ENCODE mode.
...
//
//		/**
//		 * Constructs a {@link Base64Code.OutputStream} in either ENCODE or DECODE mode.
//		 * <p/>
//		 * Valid options:
//		 * <p/>
//		 * <pre>
