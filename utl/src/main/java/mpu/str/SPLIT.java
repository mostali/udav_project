...
public class SPLIT {
	...
	public static List<String> allByNLh(String lines) {
		return SPLIT.allBy(lines, STR.NL_HTML);
	}
	...
	public static String[] argsByNLh(String str) {
		return argsBy(str, STR.NL_HTML);
	}
