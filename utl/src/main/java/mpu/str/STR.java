...
public class STR {
	...
	public static int dtRecCounter = -1;

	public static String increment() {
		if (++dtRecCounter > 99) {
			dtRecCounter = 0;
		}
		return dtRecCounter > 9 ? dtRecCounter + "" : "0" + dtRecCounter;
	}

	public static String calcPattern(String in) {

		String pt3 = in.substring(0, 3);
		...
		switch (pt3) {
			...
			case "719":
				...
				break;
			default:
				part2 = "0" + pt3.substring(0, 2);
				break;

		}
		return part1 + part2 + "/" + pt3 + increment();
	}
...
//	}
	...
	public static String substr(String str, int startOrEndCount, String... defRq) {
		try {
			if (startOrEndCount == 0) {
				return str;
			} else if (str.length() == startOrEndCount) {
				return "";
			}
...
//	}
	...
	public static String trimRight(String rsp) {
