...
public class STR {
    ...
    public static final String DEL = SYMJ.ARROW_LR;
    public static final String DELR = "▶";
    public static final String DELL = "◀";
    public static final String DELU = "⏏";
    public static final String DELP = SYMJ.POINT;
...
//		}
        ...
        P.exit(removeEnd("asd", "asda", true));
        P.exit(TKN.two("a", 1));
...
//		U.exit("2:" + two[2]);
    ...
    public static String removeStart(String pattern, String startsWith, boolean... skipError) {
        return removeStart(pattern, false, startsWith, skipError);
    }

    public static String removeStart(String pattern, boolean ignoreCase, String startsWith, boolean... skipError) {
    ...
    public static String removeEnd(String pattern, String endsWith, boolean... skipError) {
        return removeEnd(pattern, false, endsWith, skipError);
    }

    public static String removeEnd(String pattern, boolean ignoreCase, String endsWith, boolean... skipError) {
    ...
    public static String removeStartQk(String string, String first, boolean... rekursive) {
    ...
    public static String removeEndQk(String string, String end, boolean... rekursive) {
    ...
    public static String removeStartEndQk(String src, String rmm, boolean... recursive) {
        return removeStartEndQk(src, rmm, rmm, recursive);
    }

    public static String removeStartEndQk(String src, int pfxLen, int sfxLen) {
        String woStart = src.substring(pfxLen);
        String woEnd = woStart.substring(0, woStart.length() - sfxLen);
        return woEnd;
    }

    public static String removeStartEndQk(String src, String pfx, String sfx, boolean... recursive) {
        boolean rr = ARG.isDefEqTrue(recursive);
        src = removeStartQk(src, pfx, rr);
        src = removeEndQk(src, sfx, rr);
        return src;
    }
    ...
    public static String formatAllOr(String def, Object... messages) {
        ...
        switch (messages.length) {
            ...
            default:
                ...
                return STR.removeEndQk(sb.toString(), del);
        }
    }
    ...
    public static String TB(int count) {
        return repeat(TAB, count);
    }

    public static String NL(int count) {
        return repeat(NL, count);
    }

    public static String addIfAbsent(String str, String startWith) {
        return str == null ? str : str.startsWith(startWith) ? str : startWith + str;
    }
    ...
    public static String substr(String str, int startIndex, int endIndex, String... defRq) {
        try {
            ...
            return ARG.throwErr(() -> new RequiredRuntimeException(ex, "Error substring start(%s) and end(%s) from pattern '%s'", startIndex, endIndex, str), defRq);
        }
    }
    ...
    public static String substrBetweenStartEnd(String str, String start, String end, String... defRq) {
        ...
        return ARG.throwErr(() -> new RequiredRuntimeException("String '%s' must start with '%s' and ends with '%s'", orgStr, start, end), defRq);
    }
    ...
    public static String substrCount(String str, int startOrEndCount, String... defRq) {
        try {
            ...
            return ARG.throwErr(() -> new RequiredRuntimeException(ex, "Error substring length(%s) from pattern '%s'", startOrEndCount, str), defRq);
        }
    }
    ...
    public static String substrCount(String str, int startCount, int endCount, String... defRq) {
        ...
        if (cutLen > str.length()) {
            return ARG.throwErr(() -> new RequiredRuntimeException("Too many cut-size (%s) vs string (%s) '%s'", cutLen, str.length(), cutLen <= 20 ? str : toStringSE(str, 10, str)), defRq);
    ...
    public static String trimRightSpecial(String rsp) {//wth rsp null?
        return STR.removeEndQk(rsp, STR.RSP_NULL, true);
    }

    public static String trimRight(String rsp) {//wth rsp null?
        return STR.removeEndQk(rsp, " ", true);
    }

    public static String trimLeft(String rsp) {//wth rsp null?
        return STR.removeStartQk(rsp, " ", true);
    }
