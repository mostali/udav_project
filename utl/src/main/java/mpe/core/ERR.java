...
//		ERR.getStackTrace(ex);
	...
	public static @NotNull String getStackTraceShort(Exception ex, int targetCount) {
...
//	}
	...
	public static String getMessagesAsStringWithHead(Collection<Throwable> errors, String head, boolean... ol) {
		...
		return msgBuilder.skipEmpty().buildSB(errors).toString();
	}
	...
	public static String toStringRoleMode(Throwable ex) {
