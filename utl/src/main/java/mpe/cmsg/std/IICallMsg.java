...
public class IICallMsg extends CallMsg {
	...
	public static final String KEY = "iipromt";
	public static final String LINE0 = "iipromt:";
	...
	@Override
	public String subtype(Object... defRq) {
		return StdType.IIPROMPT.name();
	}
...
//		String net = (String) headersMap.get("net");
	...
	public String toString() {
		return "IICallMsg(errs*" + X.sizeOf0(getErrors()) + ")" + STR.NL + msg;
	}
