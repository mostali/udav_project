...
public class SendCallMsg extends CallMsg {
	...
	public static class RunnerLocalSM {
		@SneakyThrows
		public static void main(String[] args) {
			SendCallMsg sendCallMsg = SendCallMsg.of(Paths.get("/opt/appVol/bea/.planes/.index/sendmsg/.forms/sendmsg/AppNotes.props"));
			sendCallMsg.call(true);
		}
	}
	...
	public static SendCallMsg of(Path file) {
		SendCallMsg callMsg = of(RW.readString(file));
	...
	public Object call(boolean throwIfHasError, Object... args) {
		...
		Object rslt = ZBin.MAIL.newJarCall().invokeStringArgs(getHeaders_SEQARGS());
