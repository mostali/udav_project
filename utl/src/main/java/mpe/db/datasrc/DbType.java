...
public enum DbType {
	...
	//GoogleSheet
	public static final AtomicReference<Function3T<Path, String, String, List<List>, IOException>> LOADER_GS = new AtomicReference<>();
	public static final AtomicReference<FunctionV4T<Path, String, String, List<List>, IOException>> WRITER_GS = new AtomicReference<>();

	public Function3T<Path, String, String, List<List>, IOException> getLoaderGs() {
		IT.state(GS == this, "this loader only for %s", this);
		return LOADER_GS.get();
	}

	public FunctionV4T<Path, String, String, List<List>, IOException> getWriterGs() {
