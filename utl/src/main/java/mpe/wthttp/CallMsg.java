...
import mpe.wthttp.core.FileNode;
...
//		PyCallMsg callMsg = (PyCallMsg) ofNode(FileNode.of("/opt/appVol/bea/.planes/.index/test/.forms/PYTHON-RXO/AppNotes.props"));
		JarCallMsg callMsg = JarCallMsg.ofNode(FileNode.of("/opt/appVol/bea/.planes/.index/test/.forms/get sheet row/AppNotes.props"));
...
//		X.exit(callMsg.call(true));
	...
	public static CallMsg ofNode(INode iNode) {
		String nodeData = iNode.toNodeData();
