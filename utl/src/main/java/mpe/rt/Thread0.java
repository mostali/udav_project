...
public class Thread0<R> extends Thread {
	...
	public R getResultObject(R... defRq) {
		return _result != null && _result.get() != null ? _result.get() : ARG.throwMsg(() -> "Except not null result", defRq);
	}

	public AtomicReference<R> getResultObjectAsRef(AtomicReference<R>... defRq) {
		return _result != null ? _result : ARG.throwMsg(() -> "Except not null result", defRq);
	}
	...
	public MultiCauseException getErrorsAsMultiException(MultiCauseException... defRq) {
		return hasErrorsAny() ? new MultiCauseException(getErrorsAny()) : ARG.throwMsg(() -> X.f("Errors not found"), defRq);
	}
	...
	public R getAndWaitResult(long joinMs, R... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Except not null result, but happens timeout"), defRq);
	}
