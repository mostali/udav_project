...
//	}
	...
	public void set_result_error(Throwable t) {
		...
		IllegalStateException err = new IllegalStateException("error already init");
	...
	protected void set_result_globalError(Throwable t) {
		...
		IllegalStateException err = new IllegalStateException("GlobalError already init");
		err.printStackTrace(System.err);
		throw err;
	}
