...
public class AsyncThread {
	...
	public static void main(String[] args) {
		CompletableFuture<Void> future = CompletableFuture.runAsync(() -> SLEEP.sec(3, "wait 5 sec"));
		CompletableFuture<Void> futureErr = CompletableFuture.runAsync(() -> {
			SLEEP.sec(3, "wait 5 sec");
			X.throwException("errAfter3SEC");
		});

		SLEEP.sec(4, "wait other");
