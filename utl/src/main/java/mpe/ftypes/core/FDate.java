...
//
	...
	public static final String YYYYMMDDmm = "yyyyMMddmm";
	public static final String YYYYMMDDmmhh = "yyyyMMddHHmm";
	...
	public static final String DB_ISO_STANDART = "yyyy-MM-dd HH:mm:ss";
	public static final String APP_STANDART_LOG_DATE_FORMAT = "MM-dd;HH:mm:ss.SSS";
	public static final String APP_STANDART_LOG_DATE_FORMAT_SIMPLE = "MM-dd;HH:mm:ss.SSS";

	@SneakyThrows
	public static Date DB_ISO_STANDART(String pattern, Date... defRq) {
		try {
			return new SimpleDateFormat(DB_ISO_STANDART).parse(pattern);
		} catch (ParseException ex) {
			return ARG.toDefThrow(ex, defRq);
		}
	}

	public static final String FFULL_YYYY_MM_DD_T_HH_MM_SS_SSSXXX = "yyyy-MM-dd'T'HH:mm:ss.SSSXXX";
	...
	public static final ZoneOffset DEFAULT_ZONE_OFFSET = ZoneOffset.of("+03:00");
	...
	public static Date parseWithOffset(String date) {
		OffsetDateTime offsetDateTime = OffsetDateTime.of(java.time.LocalDateTime.parse(date), DEFAULT_ZONE_OFFSET);
		return Date.from(offsetDateTime.toInstant());
	}

	public static SimpleDateFormat FFULL_YYYY_MM_DD_T_HH_MM_SS_SSSXXX() {
		return new SimpleDateFormat(FFULL_YYYY_MM_DD_T_HH_MM_SS_SSSXXX);
	}
