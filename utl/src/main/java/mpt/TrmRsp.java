...
public class TrmRsp extends RuntimeException {
	...
	public static TrmRsp OK(String[][] info) {
		return OK(StringWalkBuilder.getInfoString(info));
	}
	...
	public static TrmRsp MSG(Collection msg) {
		String collect = JOIN.NL(msg).toString();
		return new TrmRsp("\n" + collect);
	}
	...
	public static TrmRsp ERR(Object result, int status, Throwable error, String message, Object... msgArgs) {
		...
		TrmRsp trmResponse = error == null ? new TrmRsp(ERR.isPosNotZero(status), result, msgFail) : new TrmRsp(ERR.isPosNotZero(status), result, msgFail, error);
		return trmResponse;
	}
	...
	public static TrmRsp FAIL(Throwable error, int status, Object result, String msg, Object... msgArgs) {
		...
		TrmRsp trmResponse = new TrmRsp(ERR.isNegNotZero(status), result, msgFail, ERR.NN(error));
		return trmResponse;
	}
