...
import mpc.json.expt.MapDeserializerDoubleAsIntFix;
import mpc.num.UNum;
import mpe.core.P;
import mpu.core.ARG;
import mpu.core.ARR;
...
//		String json = toStringJson(Map.of(1, Map.of(10, "-10-"),2, Map.of(20, "-20-")));
...
//	}
	...
	public static String toStringJson(Map json, boolean... serializeNulls) {
		return getGson(serializeNulls).toJson(json);
	}
	...
	public static JsonObject toJsonObjectFromAnyObject(Object issue) {
		return of(toStringJson_FromObject(issue), JsonObject.class);
	}

	public static JsonArray toJsonArrayFromAnyObject(Object issue) {
		return of(toStringJson_FromObject(issue), JsonArray.class);
	}
...
//			.registerTypeAdapter(CqlSearchResult.class, new CqlSearchResultDeserializer()).create();
	...
	public static String toStringPretty(String jsonString) {
		return toStringPretty(jsonString, false);
	}

	public static String toStringPretty(String jsonString, boolean serializeNulls) {
		JsonObject json = JsonParser.parseString(jsonString).getAsJsonObject();
		return getGsonWith(true, serializeNulls).toJson(json);
	}

	public static @NotNull Gson getGson(boolean... serializeNulls) {
		return ARG.isDefEqTrue(serializeNulls) ? getGsonWith(false, ARG.isDefEqTrue(serializeNulls)) : new Gson();
	}

	public static Gson getGsonWith(boolean pretty, boolean serializeNulls) {
	...
	public static String toStringScientific(String jsonString) {
		...
		if (true) {
			...
			gsonBuilder.registerTypeAdapter(Double.class, new JsonSerializer<Number>() {
				@Override
			...
			;
			return toStringJson(gson0.fromJson(jsonString, Map.class));
