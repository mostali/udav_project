...
public class UGson {
	...
	public static List<JsonObject> toJsonObjectFromListAnyObject(List<Object> issue) {
		return issue.stream().map(o -> toJsonObjectFromAnyObject(o)).collect(Collectors.toList());
	}
