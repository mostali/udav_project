...
//	}
	...
	public static void writeSt(Class clazz, String fieldName, Object fieldValue, boolean isFullSearch, boolean modifyAccessibleToTrue, boolean... noThrowError) {
		try {
			writeSt0(clazz, fieldName, fieldValue, isFullSearch, modifyAccessibleToTrue);
	...
	public static void write(Object obj, String fieldName, Object fieldValue, boolean isFullSearch, boolean modifyAccessibleToTrue, boolean... noThrowError) {
		try {
			write0(obj, fieldName, fieldValue, isFullSearch, modifyAccessibleToTrue);
		} catch (IllegalAccessException | NoSuchFieldException ex) {
			if (ARG.isDefEqTrue(noThrowError)) {
				return;
			}
	...
	public static void writeSt0(Class clazz, String fieldName, Object fieldValue, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException, IllegalAccessException {
		Field f = fieldSt_(clazz, fieldName, isFullSearch, modifyAccessibleToTrue);
		f.set(null, fieldValue);
	}

	public static void write0(Object object, String fieldName, Object fieldValue, boolean isFullSearch, boolean modifyAccessibleToTrue) throws IllegalAccessException, NoSuchFieldException {
		Field f = field0(object, fieldName, isFullSearch, modifyAccessibleToTrue);
	...
	public static Object readSt(Class clazz, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue, Object... defRq) {
		try {
			return readSt0(clazz, fieldName, isFullSearch, modifyAccessibleToTrue);
		} catch (Exception ex) {
			if (ARG.isDef(defRq)) {
	...
	public static Object readSt0(Class clazz, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException, IllegalAccessException {
	...
	public static Object read(Object object, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue, Object... defRq) {
		try {
			return read0(object, fieldName, isFullSearch, modifyAccessibleToTrue);
		} catch (Exception ex) {
			if (ARG.isDef(defRq)) {
				return ARG.toDef(defRq);
			}
	...
	public static Object read0(Object object, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue) throws IllegalAccessException, NoSuchFieldException {
		return field0(object, fieldName, isFullSearch, modifyAccessibleToTrue).get(object);
	}

	public static Object readSt(Object object, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue) throws IllegalAccessException, NoSuchFieldException {
	...
	public static Method methodAny(Object object, String methodName, boolean modifyAccessibleToTrue, Method... defRq) {
		try {
			return method0(object.getClass(), methodName, null, true, modifyAccessibleToTrue);
		} catch (Exception ex) {
	...
	public static Method method(Class clazz, String methodName, Class[] paramTypes_Or_MbAnyPAramas, Boolean isStaticMethod, boolean isFullSearch, boolean modifyAccessibleToTrue, Method... defRq) {
		try {
			return paramTypes_Or_MbAnyPAramas == null ? method0(clazz, methodName, isStaticMethod, true, modifyAccessibleToTrue) : method0(clazz, methodName, paramTypes_Or_MbAnyPAramas, isStaticMethod, true, modifyAccessibleToTrue);
		} catch (Exception ex) {
			return ARG.throwErr(ex, defRq);
		}
	}

	public static Method method0(Class clazz, String methodName, Boolean isStaticMethod, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchMethodException {
		while (clazz != null) {
	...
	public static Method method0(Class clazz, String methodName, Class[] parameterTypes, Boolean isStaticMethod, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchMethodException {
		...
		throw new NoSuchMethodException(STR.f("Class [%s]. Method%s [%s]. WithParams [%s]. FullSearch [%s]. Not found.", clazzOrg, isStaticMethod ? "(St)" : "", methodName, Arrays.asList(parameterTypes), isFullSearch));
	}


	public static List<Method> methods0(Class clazz, Class[] withAnnotation, Class[] parameterTypes, Boolean isStaticMethod, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchMethodException {
		return methods0(false, clazz, withAnnotation, parameterTypes, isStaticMethod, isFullSearch, modifyAccessibleToTrue);
	}


	public static List<Method> methods0(boolean onlyFirst, Class clazz, Class[] withAnnotation, Class[] parameterTypes, Boolean isStaticMethod, boolean isFullSearch, boolean modifyAccessibleToTrue, List<Method>... defRq) throws NoSuchMethodException {
	...
	public static class ANO {
		...
		public static List<Annotation> getAnoFromMethod(Method method, Class[] needleAnnotations, List<Annotation>... defRq) {
			...
			return ARG.throwMsg(() -> X.f("Method [%s] will be contain all annotation [%s] vs [%s]", method, ARR.as(needleAnnotations), finded), defRq);
		...
		public static List<Annotation> getAnoFromMethodParameter(Method method, Class[] needleAnnotations, List<Annotation>... defRq) {
			...
			return ARG.throwMsg(() -> X.f("Method parameter [%s] will be contain all annotation [%s] vs [%s]", method, ARR.as(needleAnnotations), finded), defRq);
...
//			}
	...
	public static Field field(Object object, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue, Field... defRq) {
		try {
			return field0(object, fieldName, isFullSearch, modifyAccessibleToTrue);
		} catch (NoSuchFieldException e) {
			return ARG.throwErr(e, defRq);
		}
	}
	...
	public static Field field0(Object object, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		return field0(object.getClass(), fieldName, isFullSearch, modifyAccessibleToTrue);
	}

	public static Field field0(Class clazz, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		return fieldFind0(clazz, null, null, fieldName, null, false, isFullSearch, modifyAccessibleToTrue);
	}
	...
	public static Field fieldSt_(Class clazz, String fieldName, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		return fieldFind0(clazz, null, null, fieldName, null, true, isFullSearch, modifyAccessibleToTrue);
	}
	...
	public static List<Field> fields(Class clazz, Class fieldType, List<Class> ano, List... defRq) {
		try {
			return fieldsFind0(clazz, fieldType, ano);
		} catch (NoSuchFieldException e) {
			return ARG.throwErr(e, defRq);
		}
	}
	...
	//--------------------------------
	private static Field fieldFind0(Class clazz, Class fieldType, List<Class> ano, String fieldName, StringConditionPattern fieldNameStringCondition, Boolean isStatic, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		List<Field> first = fieldsFind0(clazz, fieldType, ano, IT.NN(fieldName), fieldNameStringCondition, isStatic, isFullSearch, true, modifyAccessibleToTrue);
		return first.get(0);
	}

	private static Field fieldFind0(Class clazz, String fieldName, Boolean isStatic, boolean isFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		List<Field> first = fieldsFind0(clazz, null, null, IT.NN(fieldName), null, isStatic, isFullSearch, true, modifyAccessibleToTrue);
		return first.get(0);
	}
	...
	public static AbsFieldType fieldAbsType_(Class clazz, Object from, String fieldName, Boolean isStatic_orNot_orAny, boolean ifFullSearch, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		...
		Field field = fieldFind0(clazz == null ? from.getClass() : clazz, fieldName, isStatic_orNot_orAny, ifFullSearch, modifyAccessibleToTrue);
		return new AbsFieldType(field, from);
	}

	public static String cn(Object obj, String... defRq) {
		return obj != null ? obj.getClass().getName() : ARG.throwErr(() -> new RequiredRuntimeException("Object is NULL"), defRq);
	}

	public static String scn(Object obj, String... defRq) {
		return obj != null ? obj.getClass().getSimpleName() : ARG.throwErr(() -> new RequiredRuntimeException("Object is NULL"), defRq);
	}

	public static String scn(Class clazz, String... defRq) {
		return clazz != null ? clazz.getSimpleName() : ARG.throwErr(() -> new RequiredRuntimeException("Class is NULL"), defRq);
	}

	public static <T> T getClassAnnotation(Class clazz, Class ano, T... defRq) {
		T annotation = (T) clazz.getAnnotation(ano);
		return annotation != null ? annotation : ARG.throwErr(() -> new RequiredRuntimeException("Except '%s' ano from page class '%s'", ano, clazz), defRq);
	}
...
//		Primitives.wrap()
		...
		return ARG.throwMsg(() -> X.f("Class '%s' is not primitive class", primitiveClass.getName()), defRq);
	}
	...
	private static List<Field> fieldsFind0(Class clazz, Class fieldType, List<Class> ano) throws NoSuchFieldException {
		return fieldsFind0(clazz, fieldType, ano, null, null, null, true, false, true);
	}

	private static List<Field> fieldsFind0(Class clazz, Class fieldType, List<Class> ano, String fieldName, StringConditionPattern fieldNameStringCondition, Boolean isStatic, boolean isFullSearch, boolean onlyFirst, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		return fieldsFind0(clazz, new FindFieldsPredicate(fieldType, ano, fieldName, fieldNameStringCondition), isStatic, isFullSearch, onlyFirst, modifyAccessibleToTrue);
	}

	private static List<Field> fieldsFind0(Class clazz, FindFieldsPredicate findFieldsPredicate, boolean isFullSearch, boolean onlyFirst, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		return fieldsFind0(clazz, findFieldsPredicate, null, isFullSearch, onlyFirst, modifyAccessibleToTrue);
	}

	private static List<Field> fieldsFind0(Class clazz, FindFieldsPredicate findFieldsPredicate, Boolean isStaticFields, boolean isFullSearch, boolean onlyFirst, boolean modifyAccessibleToTrue) throws NoSuchFieldException {
		Class clazz_ = clazz;
	...
	public static <T> T fieldValueSet(Object obj, String fieldname, T value, boolean fullSearch, T... defRq) {
		try {
			RFL.field0(obj, fieldname, fullSearch, true).set(obj, value);
			return value;
	...
	public static Object fieldValue(Object obj, String fieldname, boolean fullSearch, Field... defRq) {
		try {
			return RFL.field0(obj, fieldname, fullSearch, true).get(obj);
		} catch (IllegalAccessException | NoSuchFieldException e) {
			if (ARG.isDef(defRq)) {
				return ARG.toDef(defRq);
			}
	...
	public static <T> List<T> fieldValues_(Class clazz, Object obj, FindFieldsPredicate predicate, boolean fullSearch) throws NoSuchFieldException, IllegalAccessException {
		List<Field> fields = fieldsFind0(clazz == null ? obj.getClass() : clazz, predicate, fullSearch, false, true);
	...
	public static <T> Map<String, T> fieldValuesMap(Class clazz, Object obj, Class<T> fieldType, boolean fullSearch, Map<String, T>... defRq) {
		...
		List<Field> fields = fieldsFind0(clazz == null ? obj.getClass() : clazz, findFieldsPredicate, fullSearch, false, true);
		...
		return !fnMap.isEmpty() ? fnMap : ARG.throwMsg(() -> X.f("Except field values"), defRq);
	}
	...
	public static Object fieldValue_(Object obj, String fieldname, boolean fullSearch) throws NoSuchFieldException, IllegalAccessException {
		Field field = RFL.field0(obj, fieldname, fullSearch, true);
	...
	@RequiredArgsConstructor
	public static class RflArgs {
		final Class[] struct2;

		public static RflArgs ofStruct(Class... struct2) {
			return new RflArgs(struct2);
		}

		public RflArgs(Class[] struct2, Object[] kv) {
			this.struct2 = struct2;
		}

		public static Pare<Class[], Object[]> toRflArgsSeqNN(Object... seq) {
			List<Class> tps = new LinkedList();
			List vls = new LinkedList();
			for (Object o : seq) {
				tps.add(o.getClass());
				vls.add(o);
			}
			return Pare.of(tps.toArray(Class[]::new), vls.toArray(Object[]::new));
		}

		public static Pare<Class[], Object[]> toRflArgs_AsPareClassValue(Object... paresClassValue) {
			List<Class> tps = new LinkedList();
			List vls = new LinkedList();
			for (int i = 0; i < paresClassValue.length; i += 2) {
				Object key = paresClassValue[i];
				IT.state(key instanceof Class, "Except key [%s] as class", key);
				tps.add((Class) key);
				Object val = paresClassValue[i + 1];
				vls.add(val);
				if (val != null) {
					IT.isType(val, (Class) key, "Except value [%s] of class [%s]", val, key);
				}
			}
			return Pare.of(tps.toArray(Class[]::new), vls.toArray(Object[]::new));
		}
		...
		@Deprecated
		public static Pare<Class[], Object[]> toRflArgsForStruct(Class[] struct2, Object... keyValues) {
			Map<Class, Object> classObjectMap = MAP.ofKeyValuesOfStruct(struct2[0], struct2[1], keyValues);
			...
			return Pare.of(parameterTypes, paramterObjects);
		}
	}
...
//		RflArgs rflArgs = RflArgs.ofStruct(Class.class, Object.class,keyValues);
		Pare<Class[], Object[]> pare = RflArgs.toRflArgsSeqNN(keyValues);
		return invokeJarSt(jarFile, clazzFullName, methodName, pare.key(), pare.val());
	}
	...
	public static Object invokeJarSt(Path jarFile, String clazzFullName, String methodName, Class[] parameterTypes, Object[] paramterObjects, Object... defRq) {
		try {
			return invokeJarSt0(jarFile, clazzFullName, methodName, parameterTypes, paramterObjects);
		} catch (Exception e) {
			if (ARG.isDef(defRq)) {
				return ARG.toDef(defRq);
			}
	...
	public static Object invokeJarSt0(Path jarFile, String clazzFullName, String methodName) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, MalformedURLException {
		return invokeJarSt0(jarFile, clazzFullName, methodName, new Class[0]);
	}

	public static Object invokeJarSt0(Path jarFile, String clazzFullName, String methodName, Class[] parameterTypes, Object... paramterObjects) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, MalformedURLException {
		...
		Method method = method0(classToLoad, methodName, parameterTypes, true, true, false);
	...
	public static Object invokeSimple(Object object, String methodName, Object... defRq) {
		try {
			return invokeObj0(object, methodName, new Class<?>[0], new Object[0]);
	...
	public static Object invokeObj0(Object object, String methodName) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
		return invokeObj0(object, methodName, new Class<?>[0], new Object[0]);
	}

	public static Object invokeObj(Object object, String methodName, Object... defRq) {
		return invokeObj(object, methodName, new Class<?>[0], new Object[0], defRq);
	}

	public static Object invokeObj(Object object, String methodName, Class[] types, Object[] args, Object... defRq) {
		try {
	...
	public static Object invokeObj0(Object object, String methodName, Class[] types, Object[] args) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
		return invokeImpl(object, object.getClass(), methodName, types, args);
	}
	...
	public static Object invokeStRq(Class clazz, String methodName, Class[] types, Object[] args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		return invokeStImpl(null, clazz, methodName, types, args);
	}
...
//		Method declaredMethod = clazz.getDeclaredMethod(methodName, types);
	...
	public static <T> T instEmptyConstructor(Class<T> type, boolean isPrivate, T... defRq) {
		try {
			return inst0(type, isPrivate);
		} catch (NoSuchMethodException | InstantiationException | IllegalAccessException |
				 InvocationTargetException ex) {
			return ARG.throwErr(() -> new RequiredRuntimeException(ex, "Error create instance type '%s', private '%s'", type.getName(), isPrivate), defRq);
		}
	}
...
//	}
	...
	public static <T> T instWithArg(Class<T> type, Object arg, T... defRq) {
		Class<?> aClass = arg.getClass();
		try {
			return con0(type, aClass).newInstance(arg);
		} catch (Exception ex) {
			return ARG.throwErr(() -> new RequiredRuntimeException(ex, "Error create instance type '%s', class(arg) '%s', class_obj(arg) '%s'", type.getName(), ARR.as(aClass), ARR.as(arg)), defRq);
		}
	}

	public static <T> T inst(Class<T> type, Class<?>[] class_arg, Object[] obj_arg, T... defRq) {
		try {
			return con0(type, class_arg).newInstance(obj_arg);
		} catch (Exception ex) {
			return ARG.throwErr(() -> new RequiredRuntimeException(ex, "Error create instance type '%s', class(arg) '%s', class_obj(arg) '%s'", type.getName(), ARR.as(class_arg), ARR.as(obj_arg)), defRq);
		}
	}
	...
	public static <T> T inst(Class<T> type, Class<?> class_arg, Object obj_arg, T... defRq) {
		try {
			...
			return ARG.throwErr(() -> new RequiredRuntimeException(ex, "Error create instance type '%s', class(arg) '%s', class_obj(arg) '%s'", type.getName(), class_arg, obj_arg), defRq);
		}
	}

	public static <T> T inst0(Class<T> type, boolean... isPrivate) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
		return inst0(type, ARG.isDefEqTrue(isPrivate), new Class<?>[0], new Object[0]);
	}

	public static <T> T inst0(Class<T> type, boolean isPrivate, Class<?>[] class_args, Object[] init_args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
		return con0(type, isPrivate, class_args).newInstance(init_args);
	}

	public static <T> T inst0(Class<T> type, Class<?> class_args, Object init_args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
		return con0(type, class_args).newInstance(init_args);
	}
	...
	public static <T> Constructor<T> con(Class<T> type, boolean isPrivate, Class<?> class_args, Constructor... defRq) {
		try {
			return con0(type, isPrivate, class_args);
		} catch (Exception ex) {
			if (ARG.isDef(defRq)) {
				return ARG.toDef(defRq);
			}
	...
	public static <T> Constructor<T> con0(Class<T> type, boolean isPrivate, Class<?>... class_args) throws NoSuchMethodException {
		Constructor<T> con = con0(type, class_args);
		if (isPrivate) {
	...
	public static <T> Constructor<T> con0(Class<T> type, Class<?>... class_args) throws NoSuchMethodException {
	...
	public static Class clazz(String className, Class... defRq) {
		try {
			return clazz0(className);
		} catch (ClassNotFoundException e) {
			return ARG.throwErr(e, defRq);
		}
	}

	public static Class clazz0(String className) throws ClassNotFoundException {
	...
	public static class CallToMethod<R> {
		...
		public R call(Object... methodObjects) {
			...
			if (callToObject != null) {
				return (R) invokeObj(callToObject, method, methodTypes, methodObjects);
			} else {
	...
	static void runTest() throws InvocationTargetException, IllegalAccessException, NoSuchFieldException, NoSuchMethodException {
		Test t = new Test();
		RFL.write0(t, "field", 123, true, true);
		RFL.writeSt0(TestStatic.class, "field", 123, true, true);
		Sys.p("Test read field is ok ::: " + UTest.testEquals(read0(t, "field", true, true), t.field));
		Sys.p("Test invoke method is ok ::: " + invokeObj0(t, "m"));
		Sys.p("Test read field is ok ::: " + UTest.testEquals(read0(t, "field", true, true), TestStatic.field));
		Sys.p("Test read static field is ok ::: " + UTest.testEquals(readSt0(TestStatic.class, "field", true, true), TestStatic.field));
		Sys.p("Test invoke static method is ok ::: " + invokeStRq(TestStatic.class, "m", new Class[0], new Object[0]));
	}
