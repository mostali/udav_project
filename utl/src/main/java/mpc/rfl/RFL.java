...
//	}
	...
	public static List<Method> methods0(boolean onlyFirst, Class clazz, Class[] withAnnotation, Class[] parameterTypes, Boolean isStaticMethod, boolean isFullSearch, boolean modifyAccessibleToTrue, List<Method>... defRq) throws NoSuchMethodException {
		...
		throw new NoSuchMethodException(X.f("Class [%s]. Ano[%s]. WithParams [%s]. FullSearch [%s]. Not found.", //
				clazzOrg, isStaticMethod ? "(St)" : "", S_.mapToList(ARR.asSafeNPE(withAnnotation), //
						RFL::scn), S_.mapToList(ARR.asSafeNPE(parameterTypes), RFL::scn), //
				isFullSearch));
	}
...
//		RflArgs rflArgs = RflArgs.ofStruct(Class.class, Object.class,keyValues);
	...
	public static Object invokeSt0(Class clazz, String methodName, Class[] types, Object[] args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		return invokeStImpl(null, clazz, methodName, types, args);
	}
...
//	}
	...
	static void runTest() throws InvocationTargetException, IllegalAccessException, NoSuchFieldException, NoSuchMethodException {
		...
		Sys.p("Test invoke static method is ok ::: " + invokeSt0(TestStatic.class, "m", new Class[0], new Object[0]));
	}
