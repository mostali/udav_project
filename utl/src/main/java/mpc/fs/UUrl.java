...
//			P.p(UUrl.getPathFromUrl("htpp://asd.asd"));
	...
	public static class TestUrlPathExtension {
		public static void main(String[] args) {
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath("/logo.png", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath("/logo.png/", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath("/logo.png?", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath("/path.a/logo.png?", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath("/.png?", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath(".png?", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath(".png", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath("./", ""), ""));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath("./?", ""), ""));
	...
	public static class TestUrlPathExtension_First {
		public static void main(String[] args) {
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First("/logo.png", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First("/logo.png/", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First("/logo.png?", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First("/path.ext0/logo.png?", ""), "ext0"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First("/.png?", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First(".png?", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First(".png", ""), "png"));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First("./", ""), ""));
			ERR.state(EQ.eq(UUrl.getExtFromUrlPath_First("./?", ""), ""));
			Sys.p("ok:getPathFromUrl");
		}
	}
	...
	public static class TestUrlPathFirstItem {
		public static void main(String[] args) {
			ERR.state(UUrl.getPathFirstItemFromUrlPath("", null) == null);
			ERR.state(UUrl.getPathFirstItemFromUrlPath("/", null) == null);
			ERR.state(UUrl.getPathFirstItemFromUrlPath("//", null) == null);
			ERR.state(UUrl.getPathFirstItemFromUrlPath("///", null) == null);
			ERR.state(EQ.eq(UUrl.getPathFirstItemFromUrlPath("/sa?"), "sa"));
			ERR.state(EQ.eq(UUrl.getPathFirstItemFromUrlPath("/sa"), "sa"));
			ERR.state(EQ.eq(UUrl.getPathFirstItemFromUrlPath("/sa/"), "sa"));
			ERR.state(EQ.eq(UUrl.getPathFirstItemFromUrlPath("sa/"), "sa"));
			ERR.state(EQ.eq(UUrl.getPathFirstItemFromUrlPath("/sa/sa2"), "sa"));
			ERR.state(EQ.eq(UUrl.getPathFirstItemFromUrlPath("sa"), "sa"));
	...
	public static class TestUrlPath {
		public static void main(String[] args) {
			ERR.state(EQ.eq(UUrl.getPathFromUrl("http://site.com"), ""));
			ERR.state(EQ.eq(UUrl.getPathFromUrl("http://site.com/"), ""));
			ERR.state(EQ.eq(UUrl.getPathFromUrl("http://site.com/?"), "?"));
			//UC.state(EQ.eq(UUrl.getPathFromUrl("http://site.com//?"), "/?"));
			ERR.state(EQ.eq(UUrl.getPathFromUrl("http://site.com/sa"), "sa"));
			ERR.state(EQ.eq(UUrl.getPathFromUrl("http://site.com/sa/"), "sa/"));
			ERR.state(EQ.eq(UUrl.getPathFromUrl("http://site.com/sa/?"), "sa/?"));
			ERR.state(EQ.eq(UUrl.getPathFromUrl("http://site.com/sa?"), "sa?"));
			Sys.p("ok:getPathFromUrl");
