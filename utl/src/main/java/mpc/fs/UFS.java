...
public class UFS extends UFS_BASE {
	...
	public static void main(String[] args) {
		List<Path> uniqs = UFS.findNotTwins(Paths.get("/home/dav/pjnsi/insi/MOD_AutoSync/libs"), Paths.get("/home/dav/pjnsi/insi/libs"));
		X.exit(uniqs);
	...
	public static void removeTwins(Map<Path, List<Path>> twins) {
		ST.flatMapToList(twins.values()).forEach(UFS.RM::removeFileQk);
	}
