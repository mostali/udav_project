...
public enum EXT {
	...
	TXT, PROPS, PROPERTIES, LOG, YAML, MD, HTML, CSS, JS, JAVA, GROOVY, XML, ZUL, JSON, SH, PY, META, STATE, HEAD, CSV,//
	...
	public boolean isNotPath(Path file) {
		return !isPath(file);
	}

	public boolean isPath(Path file) {
		return this == of(file, null);
	}

	public boolean isGEXT(GEXT gext) {
