...
public class LogGetterDate extends StringCondition.IGetterDate<String> {
	...
	public static final String FORMAT_DEFAULT = FDate.APP_STANDART_LOG_DATE_FORMAT;
	...
	public static LogGetterDate buildDefault() {
		return of(FORMAT_DEFAULT, QDate.now().year);
	}
//	public LogGetterDate(Integer... year) {
//		this(ARG.toDefOr(Date7.now().year, year), FDate.APP_STANDART_LOG_DATE_FORMAT);
//	}
	...
	public static Date[] findMinMaxDate(Collection<String> lines, LogGetterDate logGetterDate) {
		...
		return new Date[]{ArrItem.last(collect, null), ArrItem.first(collect, null)};
	}
