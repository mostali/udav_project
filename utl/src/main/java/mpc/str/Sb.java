...
public class Sb implements CharSequence {
	...
	public Sb append(CharSequence str, Object... args) {
		data.append(X.f(str, args));
		return this;
	}

	public Sb appendl(CharSequence str, Object... args) {
	...
	public static String toStringLine(Sb buildReport, String replaceNL) {
		return STR.no(buildReport.toString(), true, true, true, replaceNL);
	}
