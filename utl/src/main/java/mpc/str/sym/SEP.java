...
//Separator
public enum SEP {
	STAR, DOLLAR, SPACE, UNDER, DOT, COMMA, DASH, COLON, SCOLON, EQ, DQ, SQ, RQ, DOG, HOUSE, GT, LT;
	...
	private CharSequence toSepL(int headFactor, SimplePosition position, boolean firstNewLine, Object title, Object... args) {
		...
		ERR.isNumber(headFactor, 10, ERR.EQ.LE, "Max head type=7");
	...
	public String __str1__(Object title, Object... args) {
		return __str1__(title, true, args);
	}
	...
	public String __str2__(Object title, Object... args) {
		return __str2__(title, true, args);
	}
