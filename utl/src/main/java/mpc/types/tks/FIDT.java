...
public class FIDT implements Comparable {

	public static final String DEL = "-";

	public static FIDT ofArgs(String... names) {
		return new FIDT((Object[]) names);
	}
	...
	public boolean equals(Object obj) {
		return obj == null || obj.getClass() != FIDT.class ? false : Arrays.equals(els, ((FIDT) obj).els);
	}
	...
	public static FIDT of(String fid) {
		IT.state(fid.contains(DEL), "wrong fid pattern '%s'", fid);
		return new FIDT(SPLIT.argsBy(fid, DEL));
	}

	public static FIDT of(Object first, Object second) {
		return new FIDT(first, second);
	}
