...
public class FIDP implements Comparable {

	public static final String DEL = ".";

	public static FIDP ofArgs(String... names) {
		return new FIDP((Object[]) names);
	}
	...
	public boolean equals(Object obj) {
		return obj == null || obj.getClass() != FIDP.class ? false : Arrays.equals(els, ((FIDP) obj).els);
	}
	...
	public static FIDP of(String fid) {
		IT.state(fid.contains(DEL), "wrong fid pattern '%s'", fid);
		return new FIDP(SPLIT.argsBy(fid, DEL));
	}

	public static FIDP of(Object first, Object second) {
		return new FIDP(first, second);
	}
