...
public class Cmd7<K, V, E, O1, O2, O3, O4> extends Cmd6<K, V, E, O1, O2, O3> {
	...
	public static <K, V, E, O1, O2, O3, O4> Cmd7<K, V, E, O1, O2, O3, O4> of7(String cmd, String[] cmd5, OBJ<K> key, OBJ<V> val, OBJ<E> ext, OBJ<O1> opt1, OBJ<O2> opt2, OBJ<O3> opt3, OBJ<O4> opt4) {
		key = toEqOrAny(ArrItem.item(cmd5, 0, null), key);
		val = toEqOrAny(ArrItem.item(cmd5, 1, null), val);
		ext = toEqOrAny(ArrItem.item(cmd5, 2, null), ext);
		opt1 = toEqOrAny(ArrItem.item(cmd5, 3, null), opt1);
		opt2 = toEqOrAny(ArrItem.item(cmd5, 4, null), opt2);
		opt3 = toEqOrAny(ArrItem.item(cmd5, 5, null), opt3);
		opt4 = toEqOrAny(ArrItem.item(cmd5, 6, null), opt4);
