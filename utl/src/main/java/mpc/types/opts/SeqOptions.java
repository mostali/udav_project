...
//		SeqOptions seq = SeqOptions.ofStrictKeys("a", "b", "-c", "d", "e", "f", "-g", "--h", "-h", "-1000");
	...
	public String getSingleOrFile(String key, String... defRq) {
		try {
			...
			return RW.readContent(Paths.get(file));
		} catch (Exception ex) {
	...
	public String[] getHLP4() {
		return HLP.getHLP4(this);
	}

	public String[] getHLP_withNulls() {
		return HLP.getHLP_withNulls(this);
	}

//	public interface HlpIq extends ITlp {
//		default boolean isUseSystemUserName() {
//			return true;
//		}
//
//	}
...
//			String tlpFile = args.getSingle("tlp", null);
//			if (PfxFile.has(tlpFile)) {
//				EnvTlp envTlp = EnvTlp.ofFile(PfxFile.toPath(tlpFile));
//				return envTlp.readAsHLP4_loginRq();
//			}
