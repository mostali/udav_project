...
//	@Deprecated
	...
	public Boolean hasDouble(String key, Boolean... defRq) {
		...
		return ARG.throwMsg(new RequiredRuntimeException("Double Arg [%s] is required", key), defRq);
	}
	...
	public Boolean hasDoubleIgnoreCase(String key, Boolean... defRq) {
		...
		return ARG.throwMsg(new RequiredRuntimeException("Double Arg [%s] is required, ignoreCase", key), defRq);
	}
