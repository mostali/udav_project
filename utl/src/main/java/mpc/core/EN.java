...
public class EN {
	...
	public static <E extends Enum> List<E> getValues(Class<E> type) {
	...
	public static int[] getIndexes(Enum... enums) {
		return Stream.of(enums).map(EN::indexOf).mapToInt(x -> x).toArray();
	}
	...
	public static boolean eq(Enum v1, Enum v2, boolean... ignoreCase_or_typeEq) {
		return v1 == null || v2 == null ? false : ARGi.isDef(ignoreCase_or_typeEq) ? EQ.equalsString(v1.name(), v2.name(), ignoreCase_or_typeEq) : v1 == v2;
	}
