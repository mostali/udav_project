...
public class BootMap implements Map<String, String>, IContractBuilder, IGetterAs {
	...
	//
	//	public BootMap0 checkAndReplaceSpringPlaceholderWithDefault(boolean... checkAndReplaceSpringPlaceholderWithDefault) {
	...
	public String get(Object key) {
		return get(key, ARR.EMPTY_STR);
	}

	@Override
	public <T> T getAs(String key, Class<T> asType, T... defRq) {
		String strVL = ARG.isDef(defRq) ? get(key, null) : get(key, ARR.EMPTY_STR);
