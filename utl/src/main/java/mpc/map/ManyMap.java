...
public class ManyMap<K, V> implements Map {
	...
	public boolean is(Object v, V instance) {
		return true;
	}
	...
	public static <K, V> V get(Map[] maps, K[] key, WhatIs what, V... defRq) {
		...
		throw new RequiredRuntimeException(Arrays.asList(key).toString());
	}
	...
	public static <K, V> V get(Map[] maps, K key, WhatIs what, V... defRq) {
		...
		throw new RequiredRuntimeException(String.valueOf(key));
	}
