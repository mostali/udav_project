...
public class Date7 extends Date {
	...
	public Date7(Date date) {
		this(Integer.parseInt(UTime7.CURRENT_YEAR.format(date)), Integer.parseInt(
				UTime7.CURRENT_MONTH.format(date)), Integer.parseInt(
				UTime7.CURRENT_DAY.format(date)), Integer.parseInt(
				UTime7.CURRENT_HOUR.format(date)), Integer.parseInt(
				UTime7.CURRENT_MINUTES.format(date)), Integer.parseInt(
				UTime7.CURRENT_SECONDS.format(date)));
	}
