...
public class AppPropDef0<T> {
	...
	public AppPropDef0 desc(String desc) {
		this.desc = desc;
		return this;
	}


	public AppPropDef0 setDefValueSupplier(Supplier<T> defValueSupplier) {
	...
	public AppPropDef0(String key, T defVal) {
		this(key, defVal, (Class<T>) IT.NN(defVal).getClass());
	}

	public AppPropDef0(String key, T defVal, Class<T> asType) {
		this(key, defVal, asType, key);
	}

	public AppPropDef0(Object[] pare) {
	...
	public AppPropDef0(String key, T defVal, Class<T> asType, String desc) {
		this.desc = desc;
...
//		}
	...
	public AppPropDef0 autoInitHolder(Class autoInitPropHolder) {
