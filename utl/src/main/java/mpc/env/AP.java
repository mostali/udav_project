...
public class AP {
	...
	public static final String AP_SYNC = "ap.sync";
//	public static final String AP_SYNC_DEFAULT = "ap.sync"
...
//	}
	...
	public static Map<String, String> getApplicationProperties_APP(boolean fresh, Map<String, String> defIfNotExist_setNNForCache) {
		if (appAP == null || ARG.isDefEqTrue(fresh)) {
			FILE apFile = FILE.of(APP.getAppDataDirOrDef().resolve(Env.FILE_APPLICATION_PROPERTIES));
			if (!apFile.fdExist()) {
