...
//	}
	public static Map<String, String> getMap(AppProfile appProfile, Map... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Application.Properties not found from resources&run.location"), defRq);
	}
	...
	public static Map<String, String> getApplicationProperties_RL(AppProfile appProfile, Map... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Application.Properties not found from run.location"), defRq);
	}
	...
	public static Map<String, String> getApplicationProperties_RSRC(AppProfile appProfile, Map... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Application.Properties not found from resources"), defRq);
	}
	...
	public static <T> T getAs(String key, Class<T> asType, T... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Except App Property Key '%s'", key), defRq);
	}
