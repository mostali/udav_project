...
//	public static final String APP_PROM_MODE = "app.prom.mode";
//
...
//	}
	...
	public static Boolean IS_APP_DEBUG;

	static {
		IS_APP_DEBUG = isDebugEnable();
	}
	...
	public static boolean isDebugEnable() {
		return "true".equals(AP.get(APP_DEBUG, null));
	}
