...
//		return Env.RPA.resolve("gnc.sqlite");
	...
	public static Path TREE_USER_STATE() {
		return AppCore0.of().path("env").resolve("users-state.sqlite");
	}

	public static Path TREE_RADIO() {
		return AppCore0.of().path("env").resolve("radio.sqlite");
	}

	public static Path TREE_BBL() {
		return AppCore0.of().path("env").resolve("bblist.sqlite");
	}

	public static Path TREE_BBLIP() {
		return AppCore0.of().path("env").resolve("bbl-ip-index.sqlite");
	}

	public static Path TREE_VERSIONED() {
		return AppCore0.of().path("env").resolve("versioned.sqlite");
	}
...
//		return IT.isFileExist(Env.HOME_LOCATION.resolve(".data/gsv/data/db$projects.sqlite"));
	...
	public static List<String> relativizeAppFile(Collection<Path> paths, String... removePfxPath) {
		return S_.mapFilterToList(paths, p -> APP.relativizeAppFile(p, removePfxPath));
	}
