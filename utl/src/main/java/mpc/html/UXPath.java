...
//		String expression = "/Tutorials/Tutorial";
	...
	public static Node parseNodeValue(String xmlData, String xPath, Node... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Except single node by xPath [%s], but cam '%s' nodes from data: %s", xPath, nodeList.getLength(), xmlData), defRq);
	}
	...
	public static List<Node> parseNodeValues(String xmlData, String xPath, List<Node>... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Except nodes by xPath [%s], but cam '%s' nodes from data: %s", xPath, nodeList.getLength(), xmlData), defRq);
	}
	...
	public static String parseString(String xmlData, String xPath, String... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("Except string by xPath [%s], but cam empty from data: %s", xPath, xmlData), defRq);
	}
	...
	public static Document stringToDocument(CharSequence xmlData, Document... defRq) {
		try {
			...
			return ARG.throwErr(() -> new RequiredRuntimeException(ex, "Error parse xml: %s", xmlData), defRq);
		}
	}
