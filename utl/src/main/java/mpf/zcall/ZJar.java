...
public class ZJar implements ZEntity {
	...
	public Object invokeWithArgs(String methodName, Object... args) {
		List<Class> allPackageClassViaClassgraph = jarFile == null ? UReflScanner.getAllPackageClassViaClassgraph(packages, ZType.ZTypeAno.class) : UReflScanner.getAllPackageClassViaClassgraph(jarFile, ZType.ZTypeAno.class, packages);
