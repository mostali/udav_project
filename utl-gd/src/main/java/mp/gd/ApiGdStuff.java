...
public class ApiGdStuff extends ApiGdExt {
	...
	public static void writeValues(Path fileKeyPath, String sheedId, String commonRange, List<List> values) throws IOException {
	...
	public static class GoogleScheetLoader {
		...
		public void saveValueRange(Path fileKeyPath, String commonRange, List<List> values) throws IOException {
