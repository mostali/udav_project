...
public class ApiGdExt extends ApiGd {
	...
	public static final Function3T<Path, String, String, List<List>, IOException> gsLoader = (pathKey, sheetid, sheetrange) -> (List<List>) ApiGdExt.loadValues_AuthFileKey(pathKey, sheetid, sheetrange, Collection.class);
	public static final FunctionV4T<Path, String, String, List<List>, IOException> gsWriter = (pathKey, sheetid, sheetrange, rows) -> ApiGdExt.writeValues_AuthFileKey(pathKey, sheetid, sheetrange, rows);
...
//		List<List<Object>> values;
	...
	public static void writeValues_AuthAuto(String sheetId, String listWithRange, List<List> rows) throws IOException {
		String keyPath = AP.get(APK_GS_KEY_PATH, null);
		if (keyPath != null) {
	...
	public static void writeValues_AuthUserAlias(String userAlias, String sheedId, String commonRange, List<List> values) throws IOException {
		writeValues_AuthFileKey(findFileKeyPath(userAlias), sheedId, commonRange, values);
	}

	public static void writeValues_AuthFileKey(Path fileKeyPath, String sheedId, String commonRange, List<List> values) throws IOException {
	...
	public static Sheets getSheetsServiceByLib(String[] credentialsLib) throws IOException {
		...
		if (M2Repo.EnvRepo.contains(IT.hasLength(IT.notNull(credentialsLib), 4))) {
