...
public class SpeechRecognition_HF {
	private SpeechClient speechClient;

	public SpeechRecognition_HF(File keyPath) throws IOException {
...
//		System.out.println("Распознанный текст: " + alternative.getTranscript());
	...
	public static void main(String[] args) throws Exception {
		...
		//export GOOGLE_APPLICATION_CREDENTIALS="/opt/appVol/tsm/__GD/gd.key.json"
//		System.setProperty("GOOGLE_APPLICATION_CREDENTIALS", "/opt/appVol/tsm/__GD/gd.key.json");

//		Path gdAuth = Paths.get("/opt/appVol/tsm/__GD/gd.key.json");

		SpeechRecognition_HF recognition = new SpeechRecognition_HF(null);
