...
//		U.exit(subtasks);
	...
	public static JiraCli initMode0_AP() {
		...
		String jiraurl = AP.get(APK_JIRA_URL, null);
		String login = AP.get("jira.login", null);
		String pass = AP.get("jira.pass", null);
...
//		List<List<Object>> values;
		...
		if (auth instanceof String) {
			...
			rsp = JiraCli.getOrCreate((String[]) auth);
		} else {
...
//		}
	...
	public static JiraCli getOrCreate(String[] hlp) {
		switch (hlp.length) {
			case 2:
				return getOrCreate(AP.get(APK_JIRA_URL), ARR.of(hlp[0], hlp[1]));
			case 3:
				return getOrCreate(hlp[2], ARR.of(hlp[0], hlp[1]));
			case 4:
				return getOrCreate(hlp[2] + ":" + IT.isInt0(hlp[3]), ARR.of(hlp[0], hlp[1]));
			default:
