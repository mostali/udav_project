...
public interface KafkaWalkerFunc extends Function<ConsumerRecord<String, String>, Boolean> {
	...
	public static void consumeMessages(String url, String topic, String groupId, Function<ConsumerRecord<String, String>, Boolean> handler) {
