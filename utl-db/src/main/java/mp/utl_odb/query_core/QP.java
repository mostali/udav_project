...
//	public static QP pVAL(Object columnValue) {
//		return param(CN.VAL, columnValue, OPR.EQ);
//	}
	...
	public static @NotNull QP likeSE(String colName, String pfx, String sfx, String... values) {
		...
		QP[] allLikesArr = S_.mapToList(allLikes, lVl -> QP.like(colName, lVl)).toArray(new QP[allLikes.size()]);
	...
	public static QP notlike(String colName, Object columnValue) {
		return param(colName, columnValue, OPR.NOTLIKE);
	}
