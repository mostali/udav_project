...
public class QP {
	...
	public static QP[] afterOrBeforeOrEq(Boolean afterBeforeEq, String colname, Object value) {
		...
		if (afterBeforeEq == null) {
			return new QP[]{value == null ? QP.pNULL(colname, true) : QP.pEQ(colname, ERR.NN(value))};
		} else if (afterBeforeEq) {
			return new QP[]{QP.pGT(colname, ERR.NN(value))};
		} else {
			return new QP[]{QP.paramAscOrDescOrRand(colname, false), QP.pLT(colname, ERR.NN(value))};
		}
	}
	 ...
	 * Order Param
	 */
	public static QP paramAscOrDescOrRand(String colName, Boolean isAscOrDescOrRand) {
