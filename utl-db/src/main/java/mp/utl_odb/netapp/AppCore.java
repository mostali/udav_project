...
public class AppCore extends AppCore0 {
	...
	public UTreeTtl treeShortLife(String dbName) {
		return UTreeTtl.tree(namespace(), dbName);
	}

	public UTreeTtl treeShortLife(String ns_child, String dbName) {
		return UTreeTtl.tree(namespace(ns_child), dbName);
	}
