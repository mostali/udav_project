...
public abstract class AModel<M extends AModel> implements Serializable {
	...
	@Deprecated
	public Object getObjectFieldAsObjectOld(String fieldName) {
		return URefl_1.getFieldObject(this, fieldName);
	}
