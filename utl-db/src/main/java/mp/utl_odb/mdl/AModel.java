...
//	}
	...
	public Object getFieldValueObjRq(String fieldName) {
		return RFL.fieldValue(this, fieldName, true);
	}

	public <T> T getFieldValueObjType(String fieldName, Class<T> type, T... defRq) {
		try {
			return ObjTo.objTo(getFieldValueObjRq(fieldName), type, defRq);
		} catch (Exception ex) {
