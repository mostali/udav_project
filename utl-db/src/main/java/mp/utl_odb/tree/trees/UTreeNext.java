...
public class UTreeNext {
	...
	public static <T> T nextItem(Collection<T> items, Object key, Object keyExt) {
		return nextItem(items, key + ":" + keyExt);
	}
	...
	public static <T> T nextItem(Collection<T> items, Object key) {
		IT.NE(items);
	...
	@NotNull
	private static UTree TREE(String dbName) {
		return UTree.tree(UTreeNext.class.getSimpleName(), dbName);
	}
}
