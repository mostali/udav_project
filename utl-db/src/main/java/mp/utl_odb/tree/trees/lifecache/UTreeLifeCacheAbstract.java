...
public abstract class UTreeLifeCacheAbstract extends Ctx3Db {
	...
	public Pare<Boolean, CtxModelCtr> checkIsAllowedOrReg(String key, long life_ms, boolean... RETURN) throws ModelLifeMsException {
		...
		try {
			CtxModelCtr model = getModel_WithMaxTTL(CKey.of(key), life_ms);
			if (model == null) {
	...
	public CtxModelCtr getModel_WithMaxTTL(CKey key, long lifeMs) throws ModelLifeMsException {
		return getModel_WithMaxTTL(this, key, lifeMs, cacheType(), false);
	}

	private static CtxModelCtr getModel_WithMaxTTL(Ctx3Db db, CKey key, long maxLifeMs, CacheType cacheType, boolean lastModel) throws ModelLifeMsException {
...
//		}
	...
	public static class ModelLifeMsException extends Exception {
		...
		public final @Getter CtxModelCtr timeModel;
