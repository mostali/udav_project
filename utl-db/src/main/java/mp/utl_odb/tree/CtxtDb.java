...
public class CtxtDb extends NamedDbUrl {
	...
	public CtxtDb updateExist(boolean updateExist) {
...
//				X.p("rslt autocleean=" + s);
	...
	public static class CtxTimeModel extends AModel<CtxTimeModel> {//implements CacheTimeUpdater.IUp
		...
		public List<AbsType> toAbsRow5() {
			return ARR.as(AbsType.of("id", getId(), Long.class), AbsType.of("key", getKey(), String.class), AbsType.of("val", getValue(), String.class), AbsType.of("ext", getExt(), String.class), AbsType.of("time", QDate.of(getTime()), QDate.class));
		}
	}
}
