...
public class JdbcUrl implements IJdbcUrl {
	...
	public static JdbcUrl of(Path dbFile, boolean... checkIsNotBlank) {
		...
		return new JdbcUrl(Ns.ofUnsafe(rootDir), filename, TypeName.FILE);
	}

	public static JdbcUrl of(String name, TypeName typeName) {
		return of((Ns) null, name, typeName);
	}

	public static JdbcUrl of(String namespace, String name, TypeName typeName) {
		return new JdbcUrl(Ns.of(namespace), name, typeName);
	}

	public static JdbcUrl of(String rootDir, String namespace, String name, TypeName typeName) {
		return new JdbcUrl(Ns.of(rootDir, namespace), name, typeName);
	}

	public static JdbcUrl of(Ns ns, String name, TypeName typeName) {
...
//			   ", typeName=" + typeName +
	...
	public JdbcUrl(Ns ns, String name, TypeName typeName) {
		this.ns = ns;
		this.name = name;
