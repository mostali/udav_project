...
//	public static String getSubDomian_part3_WHOLE(ServletRequest request, int sd3_index, String returnIfNull) {
...
//		cookie.setValue("");
	...
	public static String getHostWoSd(boolean... alreadyHere) {//unsafe - what is host without not sd3?
		return ARG.isDefEqTrue(alreadyHere) ? getHost() : USToken.lastGreedy(getHost(), ".");
	}
	...
	public static String appendPortToHostWoPath(String hostWithoutPath) {
		...
		Integer portOrNullIf80 = APP.getPort_ReturnIf80(null);
...
//	public static void closeResponseQuickly(HttpServletResponse response) {
//		.getWriter()
//	}
}
