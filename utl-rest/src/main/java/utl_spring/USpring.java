	...
	public static void postProcessEnvironment_AddProperties(ConfigurableEnvironment environment, String name, Properties properties, int position, String... relativePropertySourceName) {
		switch (position) {
			...
			case AppPropsPosition.AFTER:
				environment.getPropertySources().addAfter(ArrItem.first(relativePropertySourceName), new PropertiesPropertySource(name, properties));
				break;
			case AppPropsPosition.BEFORE:
				environment.getPropertySources().addBefore(ArrItem.first(relativePropertySourceName), new PropertiesPropertySource(name, properties));
				break;
			default:
