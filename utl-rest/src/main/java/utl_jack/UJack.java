...
public class UJack {
	...
	public static ArrayNode JA(Map<String, Object> json, String fieldname, ArrayNode... defRq) {
		...
		return ARG.throwErr(() -> new RequiredRuntimeException("JA '%s' is required", fieldname), defRq);
	}
	...
	public enum JsType {
		...
		public static JsType of(JsonNode el, JsType... defRq) {
			...
			return ARG.throwMsg(() -> X.f("JsonElement is undefined:" + (el == null ? null : el.getClass().getSimpleName())), defRq);
		}
