...
public class StatusException extends org.springframework.web.server.ResponseStatusException implements IResponseStatusException {
	...
	public ResponseEntity toResponseEntity() {
		...
		String causeReason = JOIN.allBy(" ", UErr.getAllMessages(causeEx));
		if (reasonMsg == null) {
	...
	public static StatusException OK204(HttpStatus status, String message, Object... args) {
	...
	public static StatusException CODE(HttpStatus status, String error, Object... args) {
		return new StatusException(status, error, args);
	}
