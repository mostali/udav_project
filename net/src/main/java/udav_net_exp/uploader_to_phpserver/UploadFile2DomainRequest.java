...
public class UploadFile2DomainRequest {
	...
	//		P.exit(UploadFile2DomainRequest.uploadFile("http://SITE/upload.php", "i/tmp", "/tmp/test.jpg"));
	//	}
	...
	public static String uploadFile(String serverWithUploadPhp, String serverParentDir, String fileForUpload) {
		ERR.isFileExist(fileForUpload, "uploaded file not exist");
		...
		String rslt = STR.removeControlSymbol(uploadingOfPhotoResponseString);
