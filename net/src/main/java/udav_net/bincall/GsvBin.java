...
public class GsvBin {
	...
	private static Object invokeExec0(String puid) {
		Sys.exec_SafeSpace("java", "-jar", getAndCheckJarLocation().toString(), "-puid", puid, "--gsv");
...
//		return o;
	...
	public static void main(String[] args) {
		GsvBin.invokeExec0("39");
		GsvBin.invokeContext(0, UMap.of("puid", "39", "act", "gsv"));
		P.exit();
		GsvBin.invokeContext(0, UMap.of("ut", "TTTTTTOOOOKKKKEEEEEEEEEENNNNNNNN", "oid", "-123", "top", "20231221", "return", "rows", "count", 3));
		GsvBin.invokeContext(0, UMap.of("ut", "TTTTTTOOOOKKKKEEEEEEEEEENNNNNNNN", "pid", "-123_3"));
		GsvBin.invokeContext(0, UMap.of("ut", "TTTTTTOOOOKKKKEEEEEEEEEENNNNNNNN", "oid", "-123", "from_pid", "-123_3", "count", 3));
//		P.exit(rows);
	}
