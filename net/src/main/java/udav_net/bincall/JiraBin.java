...
//			return getIssues();
		...
		public List<IssueContract> getIssuesContract(String jqlMsg) {
		...
		public Map<String, IssueContract> getIssuesAsMap(@NotNull String jqlExpression, String[] hlp) {
			List<IssueContract> issues = getIssuesContract(JqlCallMsg.buildMsgByHlp(hlp, jqlExpression));
...
//			Object o1 = apiV3().invokeMsg(jqlMsg);
		}
		{
			...
			List<IssueContract> issues = apiV3().getIssuesContract(jqlMsg);
//			Object o1 = issues;
...
//		Object o = JiraBin.of(jqlMsg).invokeMsg();
	...
	public static class JqlLoader implements Function<JqlLoader.IJqlFilter, List<IssueContract>> {
		...
		public List<IssueContract> loadByJql(JqlFilter jiraCmdFilter) {
			...
			List<IssueContract> issueContracts = apiV3().getIssuesContract(jiraCmdFilter.jqlMsg.getMsg());
