...
//			X.exit(loadTaskAsJO(null,"SUP-1593991"));
			...
			X.exit(loadAllTasksByAuth(null));
...
//	}
	...
	public static List<IssueContract> loadAllTasksByAuth(Object auth) {
...
//	final Path jar;
	...
	public interface IssueContract {
		...
		enum Prio {
			...
			MIDDLE("Средний", UColorTheme.LBLUE),//
	...
	public static List<JsonObject> loadAllTasksAsJO(Object auth) {
		List<Object> objects = loadTaskNativeAllTask(auth);
	...
	public static List<Object> loadTaskNativeAllTask(Object auth) {
		return (List<Object>) invokeContext(auth, MAP.of("all", "*"));
	}
