...
public class NoteApi {
	...
	public static final String _ACI = "_aci";
	public static final String _ADI = "_adi";
	...
	public static final String _ACI_PARTURL = "/" + _ACI;
	public static final String _ACI_PARTURL_ = _ACI_PARTURL + "/";
...
//				JHttp.POST_BODY(url, bodyLines, String.class, 200) ://
	...
	public String GET_items(String page) throws IllegalHttpStatusException {
		return GET_items(Pare.of(ItemPath.SD3_INDEX_ALIAS, page == null ? ItemPath.PAGE_INDEX_ALIAS : IT.NE(page, "set page")));
	}
	...
	public static class ZApiUrl {
		...
		public String urlToEventPageWithBody(NodeID nodeID, String oper, String k, String v) {
			...
			String sd3Part = ItemPath.isIndex(sd3) ? "" : sd3 + ".";
			...
			query += ("&k=" + k);
			String url = http() + sd3Part + domainNameWithPort + ctxPart() + _ATI_PARTURL_ + pagePart + itemNamePart + operPart + query;
			return url;
		}
