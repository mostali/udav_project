...
//	public static final String PK_REST_EXE__OLD = "rest";
	public static final String QK_STATE = QN.STATE;
	...
	@SneakyThrows
	public String PUT_item_afcType(ItemPath itemPath, String afcType, String key, String value, boolean viaPOST_GET) throws IllegalHttpStatusException {
		String url = zApiUrl.PUT_toItem_afcType(itemPath, afcType, key, value);
		return viaPOST_GET ?//
				X.throwIllegalStateException("not supported POST") :
//				JHttp.POST_BODY(url, bodyLines, String.class, 200) ://
				JHttp.GET_BODY(url, null, String.class, 200);
	}
	...
	@SneakyThrows
	public String GET_item(String nodeId, Pare... urlArgs) throws IllegalHttpStatusException {
//		return GET_item(nodeId.toItemPath(), urlArgs);
		return GET_item(NodeID.of(nodeId), urlArgs);
	}
...
//		return GET_item(nodeId.toItemPath(), urlArgs);
	...
	public static class ZApiUrl {
		...
		public String urlTo_PageNoBody_afcType(ItemPath itemPath, boolean isGetOrPut, String afcType, String key, String value) {
			String sdPart = itemPath.subdomainAsUrlPart();
			String pagePart = itemPath.pageAsUrlPart();
			String itemNamePart = itemPath.nameAsPart();
			String opPart = opSymbolPart(isGetOrPut);
			String query = queryPart();
			query += "&"+NoteApi.QK_STATE +"=" + afcType + "&k=" + key + "&v=" + value;
			return http() + sdPart + domainNameWithPort + ctxPart() + ApiCase._api._NAME + pagePart + opPart + itemNamePart + query;
		}
		...
		public String PUT_toItem_afcType(ItemPath itemPath, String afcType, String key, String value) {
			return urlTo_PageNoBody_afcType(itemPath, false, afcType, key, value);
		}
