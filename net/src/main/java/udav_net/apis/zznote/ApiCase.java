...
public enum ApiCase {
	...
	public static ApiCase valueOf(String pagename, ApiCase... defRq) {
		...
		return ARG.throwMsg(() -> X.f("Except API case of " + pagename), defRq);
	}
	...
	public static ApiCase ofServletPath(String servletPath, ApiCase... defRq) {
		...
		return ARG.throwMsg(() -> X.f("Not found any api part from servletPath: %s", servletPath), defRq);
	}
