...
public class ItemPath {
	...
	public static ItemPath getPathRelativeWithIndex(ItemPath itemPath) {
		switch (itemPath.mode) {
			...
			case PARE:
				return of(Paths.get(PLANE_INDEX_ALIAS).resolve(itemPath.pageName()).resolve(itemPath.nodeName()));
			case ALL:
				return itemPath;
			default:
...
//		return sd3 == null || sd3.length == 0 || sd3[0] == null || sd3[0].length() == 0 ? PLANE_INDEX_ALIAS : sd3[0];
//	}
	public static String wrapSd3(String sd3) {
...
//		return sd3 == null || sd3.length == 0 || sd3[0] == null ? "" : (sd3[0].equals(PLANE_INDEX_ALIAS) ? "" : sd3[0]);
//	}
	public static String unwrapSd3(String sd3) {
...
//		return path == null || path.length == 0 || path[0] == null ? "" : (path[0].equals(PAGE_INDEX_ALIAS) ? "" : path[0]);
	...
	public static Collection filterNoIndexPath(List<String> fileNames) {
		return STREAM.filterToAll(fileNames, i -> !ItemPath.ANY_INDEX_ALIAS.equals(i));
	}
	...
	public static ItemPath rootParent() {
		return ItemPath.of(Paths.get(PLANE_INDEX_ALIAS).resolve(PAGE_INDEX_ALIAS));
	}
	...
	public static String getSubdomainAsUrlPart(String sd3) {
		return isPlaneAliasIndex(sd3) ? "" : sd3 + ".";
	}
