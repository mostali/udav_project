...
public class TgMsg implements IBotMsg {
	...
	public enum MsgType {
		...
		public static MsgType of(Object o, MsgType... defRq) {
			...
			return ARG.throwMsg(() -> X.f("Undefined TG MsgType [%s]", RFL.scn(o, null), defRq));
		}
...
//	}
	...
	public void setString(PartialBotApiMethod sendObject, String method, String object) {
		RFL.invokeObj(sendObject, method, new Class[]{String.class}, new Object[]{object});
	}

	public void setBoolean(PartialBotApiMethod sendObject, String method, boolean object) {
		RFL.invokeObj(sendObject, method, new Class[]{Boolean.class}, new Object[]{object});
	}
	...
	public static void setKeyboard(PartialBotApiMethod sendObject, ReplyKeyboard keyboard) {
		...
		RFL.invokeObj(sendObject, "setReplyMarkup", new Class[]{type}, new Object[]{keyboard});
	}
...
//			} else
			if (sendObject instanceof SendDocument) {
				...
				responseObject = (Serializable) RFL.invokeObj0(bot, "execute", new Class[]{BotApiMethod.class}, new Object[]{sendObject});
