...
public class TgPollingBot extends TelegramLongPollingBot {
	...
	private UL.QueueSafe<Update> queue_updates;
	public static final int MAX_CACHE_UPDATE = 100;

	public UL.QueueSafe<Update> getQueueUpdates() {
		if (queue_updates == null) {
			queue_updates = (UL.QueueSafe<Update>) UL.cache_queuesafe_sync_FILO(MAX_CACHE_UPDATE);
		}
		return queue_updates;
	}

	public final UL.QueueSafe<Update> queue_updates_1000 = (UL.QueueSafe<Update>) UL.cache_queuesafe_sync_FILO(1000);
